...
namespace SagaDB.Item
{
    ...
    public class Item
    {
        public class ItemData
        {
            ...
            public bool noTrade, noVending, noGolemSellShop, noSoldToNPC, noStore, noGardenStore, noDrop;
        ...
        short aspd, cspd;
        uint pict_id;
        uint pict_id2; //ECOKEY 外觀複製品道具專用
        bool rental;
        ...
        public uint Refine_Sharp { get { return refine_sharp; } set { refine_sharp = value; } }//ECOKEY DEM火屬性強化借用
        public uint Refine_Enchanted { get { return refine_enchanted; } set { refine_enchanted = value; } }//ECOKEY DEM水屬性強化借用
        public uint Refine_Vitality { get { return refine_vitality; } set { refine_vitality = value; } }//ECOKEY DEM風屬性強化借用
        public uint Refine_Regeneration { get { return refine_regeneration; } set { refine_regeneration = value; } }//ECOKEY DEM光屬性強化借用
        public uint Refine_Hit { get { return refine_def; } set { refine_def = value; } }//ECOKEY DEM地屬性強化借用
        public uint Refine_Mhit { get { return refine_mdef; } set { refine_mdef = value; } }//ECOKEY DEM暗屬性強化借用
        public uint Refine_Lucky { get { return refine_lucky; } set { refine_lucky = value; } }//ECOKEY DEM屬性強化次數借用
        ...
        [JsonIgnore]
        public Dictionary<Elements, short> Element = new Dictionary<Elements, short>//ECOKEY DEM部件強化屬性
        {
            { Elements.Neutral, 0 },
            { Elements.Fire, 0 },
            { Elements.Water, 0 },
        ...
        //ECOKEY 外觀複製品道具專用
        public uint PictID2 { get { return pict_id2; } set { pict_id2 = value; } }
        ...
        /// 该道具附加的主动技能ID
        /// </summary>
        public ushort ActiveSkillID { get { return activeskillid; } set { activeskillid = value; } }
        ...
        public Item(ItemData baseData)
        {
            ...
            ActiveSkillID = baseData.activateSkill;
        ...
        public Item Clone()
        {
            ...
            item.dye = dye;
            item.activeskillid = activeskillid;
