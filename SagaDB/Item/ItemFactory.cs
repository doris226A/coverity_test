...
namespace SagaDB.Item
{
    public class ItemFactory : Factory<ItemFactory, Item.ItemData>
    {
        ...
        public Item GetItem(uint id, bool identified)
        {
            ...
            public void CalcRefineBouns(Item Equip)//ECOKEY DEM部件強化屬性
            {
                if (Equip.Refine_Lucky == 0) return;
                if (Equip.EquipSlot == null) return;
                Equip.Element[Elements.Fire] = (short)Equip.Refine_Sharp;//ECOKEY DEM火屬性強化借用
                Equip.Element[Elements.Water] = (short)Equip.Refine_Enchanted;//ECOKEY DEM水屬性強化借用
                Equip.Element[Elements.Wind] = (short)Equip.Refine_Vitality;//ECOKEY DEM風屬性強化借用
                Equip.Element[Elements.Earth] = (short)Equip.Refine_Hit;//ECOKEY DEM地屬性強化借用
                Equip.Element[Elements.Dark] = (short)Equip.Refine_Mhit;//ECOKEY DEM暗屬性強化借用
                Equip.Element[Elements.Holy] = (short)Equip.Refine_Regeneration;//ECOKEY DEM光屬性強化借用
