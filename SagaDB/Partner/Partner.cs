...
namespace SagaDB.Partner
{
    public class PartnerData
    {
        ...
        public List<uint> born_active_cubes = new List<uint>();
        public List<uint> born_passive_cubes = new List<uint>();

        public bool possessionflag;
        public ushort possessionskillid;
        public ushort possessionstatusuprate;
        ...
        public int aiMode;
        public bool ridingflag;
        public ushort commonai;
        public ushort dyingai;

        public Dictionary<byte, PartnerAdvanceStatus> AdvanceStatus = new Dictionary<byte, PartnerAdvanceStatus>();
    ...
    public class ActCubeData
    {
        ...
        // 添加技能 ID 列表
        public List<uint> SkillIds { get; set; } = new List<uint>();
    } 
}
