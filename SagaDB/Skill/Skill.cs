...
namespace SagaDB.Skill
{
    ...
    public enum EquipFlags
    {
        ...
        STAFF = 0x400000,
        PARTS_BLOW = 0x800000,
        PARTS_SLASH = 0x1000000,
        PARTS_STAB = 0x2000000,
        PARTS_LONGRANGE = 0x4000000,
        //避免error專用
        ETC_WEAPON = 0x8000000,
        EQ_ALLSLOT = 0x10000000,
        HANDBAG = 0x20000000,
        LEFT_HANDBAGHANDBAG = 0x40000000
        /*PARTS_BLOW,
        PARTS_SLASH,
        PARTS_STAB,
        PARTS_LONGRANGE,
    ...
    public class SkillData
    {
        ...
        [XmlIgnore]
        private BitArray _RawEquipFlag { get; set; }
        ...
        public int EquipFlagValue
        {
            get
            {
                ...
                _RawEquipFlag.CopyTo(intByBitArray, 0);
                return (intByBitArray[0]);
            }
            set
            {
                int[] a = { value };
                _RawEquipFlag = new BitArray(a);
            }
        }
    ...
    public class Skill
    {
        ...
        public int CastTime { get { return this.baseData.castTime; } set { this.baseData.castTime = value; } }
