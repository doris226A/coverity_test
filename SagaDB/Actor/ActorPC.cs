...
namespace SagaDB.Actor
{
    ...
    public class ActorPC : Actor, IStats
    {
        ...
        /// 镜子脸数据
        /// </summary>
        public List<ushort> MirrorFaceInfo = new List<ushort>();

        /// <summary>
        /// 镜子发型数据
        /// </summary>
        public List<ushort> MirrorHairInfo = new List<ushort>();

        /// <summary>
        /// 镜子副发数据
        /// </summary>
        public List<ushort> MirrorWigInfo = new List<ushort>();

        /// <summary>
        /// 镜子发型时限
        /// </summary>
        public List<uint> MirrorHairLimit = new List<uint>();

        /// <summary>
        /// 镜子发色数据
        /// </summary>
        public List<byte> MirrorHairColor = new List<byte>();
        ...
        /// 初始发型
        /// </summary>
        public ushort BaseHairStyle;

        /// <summary>
        /// 初始发色
        /// </summary>
        public byte BaseHairColor;

        /// <summary>
        /// 初始副发
        /// </summary>
        public ushort BaseWig;

        /// <summary>
        /// 初始脸
        /// </summary>
        public ushort BaseFace;
        ...
        Dictionary<string, ActorTimerItem> timerItem = new Dictionary<string, ActorTimerItem>();

        public bool canTrade = true, canParty = true, canPossession = true, canRing = true, showRevive = true, canWork = true, canMentor = true, canShowEquipment = true, canChangePartnerDisplay = true, canFriend = true;
        ...
        //TODO: 黑白处理反射生成buff并applyaddition
        public Dictionary<string, ActorTimerItem> TimerItems
        {
            get
            {
                return timerItem;
        ...
        /// <summary>
        /// ECOKEY 憑依在右手的寵物道具位置Slot
        /// </summary>
        public uint PartnerSlotRightHand;
        /// <summary>
        /// ECOKEY 憑依在左手的寵物道具位置Slot
        /// </summary>
        public uint PartnerSlotLeftHand;
        /// <summary>
        /// ECOKEY 憑依在衣服的寵物道具位置Slot
        /// </summary>
        public uint PartnerSlotClothes;
        /// <summary>
        /// ECOKEY 憑依在項鍊的寵物道具位置Slot
        /// </summary>
        public uint PartnerSlotAccesory;
        ...
        //一閃
        public Dictionary<PossessionPosition, int> PossessionSlots { get; set; }
        ...
        public byte JointJobLevel
        {
            ...
            set
            {
                this.jjlv = value; if (e != null)
                    e.PropertyUpdate(UpdateEvent.LEVEL, 0);
                if (this.jointJob == PC_JOB.BREEDER)
                {
                    this.breederlv = value; if (e != null)
                        e.PropertyUpdate(UpdateEvent.LEVEL, 0);
                }
                if (this.jointJob == PC_JOB.GARDNER)
                {
                    this.gardenerlv = value; if (e != null)
                        e.PropertyUpdate(UpdateEvent.LEVEL, 0);
                }
            }
        }
        byte breederlv, gardenerlv;

        /// ECOKEY 馴獸師等級
        /// </summary>
        public byte JointJobBreederLevel
        {
            get { return breederlv; }
            set
            {
                this.breederlv = value; /*if (e != null)
                    e.PropertyUpdate(UpdateEvent.LEVEL, 0);*/
        ...
        /// ECOKEY 庭園師等級
        /// </summary>
        public byte JointJobGardenerLevel
        {
            get { return gardenerlv; }
            set
            {
                this.gardenerlv = value; /*if (e != null)
                    e.PropertyUpdate(UpdateEvent.LEVEL, 0);*/
        ...
        public PC_JOB JobJoint
        {
            ...
            {
                jointJob = value;
                if (value == PC_JOB.BREEDER)
                {
                    this.jjlv = this.breederlv;
                    this.jjexp = this.breederjjexp;
                }
                if (value == PC_JOB.GARDNER)
                {
                    this.jjlv = this.gardenerlv;
                    this.jjexp = this.gardenerjjexp;
                }
            }
        }
        ...
        public ulong JointJEXP
        {
            ...
            set
            {
                ...
                if (this.jointJob == PC_JOB.BREEDER)
                {
                    this.breederjjexp = value;
                }
                if (this.jointJob == PC_JOB.GARDNER)
                {
                    this.gardenerjjexp = value;
                }
            }

        }

        ulong breederjjexp, gardenerjjexp;
        /// <summary>
        /// ECOKEY 馴獸師經驗值
        /// </summary>
        public ulong JointBreederJEXP { get { return this.breederjjexp; } set { this.breederjjexp = value; } }

        /// <summary>
        /// ECOKEY 庭園師經驗值
        /// </summary>
        public ulong JointGardenerJEXP { get { return this.gardenerjjexp; } set { this.gardenerjjexp = value; } }
        ...
        /// ECOKEY 玩家目前憑依的寵物
        /// </summary>
        public Dictionary<PossessionPosition, ActorPartner> PossesionedPartner = new Dictionary<PossessionPosition, ActorPartner>();
        ...
        /// 玩家在虚拟商城的NC
        /// </summary>
        public uint NCShopPoints
        {
            get
            {
                if (e != null)
                    e.PropertyRead(UpdateEvent.NC_POINT);
                return this.ncpoints;
            }
            set
            {
                this.ncpoints = value;
                if (e != null)
                    e.PropertyUpdate(UpdateEvent.NC_POINT, 0);
            }
        }
        ...
        /// 玩家已用掉的NC
        /// </summary>
        public uint UsedNCShopPoints
        {
            get
            {
                if (e != null)
                    e.PropertyRead(UpdateEvent.NC_POINT);
                return this.usedNCPoints;
            }
            set
            {
                this.usedNCPoints = value;
                if (e != null)
                    e.PropertyUpdate(UpdateEvent.NC_POINT, 0);
            }
        }
      ...
      //  Dictionary<uint,  bool> npcStates = new Dictionary<uint, bool>();
        //  public Dictionary<uint,bool> NPCStates { get { return this.npcStates; } set { this.npcStates = value; } }
        ...
        /// 玩家的好友限時動態
        /// </summary>
        public String FriendMemo { get { return this.friendMemo; } set { this.friendMemo = value; } }

        //ECOKEY BINGO
        SagaDB.Bingo.Bingo bingo;
        /// <summary>
        /// Bingo
        /// </summary>
        public Bingo.Bingo Bingo { get { return this.bingo; } set { this.bingo = value; } }
        ...
        /// 設置係技能
        /// </summary>
        public ConcurrentDictionary<string, List<ActorSkill>> Stackableskill = new ConcurrentDictionary<string, List<ActorSkill>>();


        [NonSerialized]
        Dictionary<string, short> statusregi = new Dictionary<string, short>();

        /// <summary>
        /// 異常抗性
        /// </summary>
        public Dictionary<string, short> StatusRegi
        {
            get
            {
                if (this.statusregi.Count == 0)
                {
                    this.statusregi.Add("Confuse", 0);
                    this.statusregi.Add("Stun", 0);
                    this.statusregi.Add("Poison", 0);
                    this.statusregi.Add("Silence", 0);
                    this.statusregi.Add("Stone", 0);
                    this.statusregi.Add("Sleep", 0);
                    this.statusregi.Add("MoveSpeedDown", 0);
                    this.statusregi.Add("Frosen", 0);
                }
                return this.statusregi;
            }
        }
        ...
        /// 當前參與的AncientArkID
        /// </summary>
        public uint AncientArkID { get { return this.ancientarkID; } set { this.ancientarkID = value; } }

        uint ancientark_questID;

        /// <summary>
        /// 玩家接受的的圖書館任務ID
        /// </summary>
        public uint AncientArk_QuestID { get { return this.ancientark_questID; } set { this.ancientark_questID = value; } }


        byte ancientark_layer;

        /// <summary>
        /// 玩家當前所在層數
        /// </summary>
        public byte AncientArk_Layer { get { return this.ancientark_layer; } set { this.ancientark_layer = value; } }

        byte ancientark_room;

        /// <summary>
        /// 玩家當前所在房間ID
        /// </summary>
        public byte AncientArk_Room { get { return this.ancientark_room; } set { this.ancientark_room = value; } }
        ...
        22～24階層へ到達 - 8
         */
        byte ancientark_clear;
        /// <summary>
        /// 玩家AA解到第幾層
        /// </summary>
        public byte AncientArk_Clear { get { return this.ancientark_clear; } set { this.ancientark_clear = value; } }
        #endregion
