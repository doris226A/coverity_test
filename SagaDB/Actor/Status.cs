...
namespace SagaDB.Actor
{
    public class Status
    {
        ...
        public short def_add_iris, mdef_add_iris, equip_def_add_rate;
        ...
        public short buy_rate_iris = 100, sell_rate_iris = 100;
        public short hp_recover_iris, sp_recover_iris, mp_recover_iris;
        public short reance_speed_iris = 0;
        public int speed_iris;
        public short part_expup_iris = 0;//ECOKEY新增IRIS寵物經驗
        ...
        public short payl_add_tamaire, volume_add_tamaire;//ECOKEY 新增負重和體積
        ...
        //木偶变身bonus
        public short min_atk1_mario = 0, min_atk2_mario = 0, min_atk3_mario = 0, max_atk1_mario = 0, max_atk2_mario = 0, max_atk3_mario = 0, min_matk_mario = 0, max_matk_mario = 0;
        public short str_mario = 0, dex_mario = 0, int_mario = 0, vit_mario = 0, agi_mario = 0, mag_mario = 0;
        public short def_mario = 0, def_add_mario = 0, mdef_mario = 0, mdef_add_mario = 0;
        public short speed_mario = 0, aspd_mario = 0, cspd_mario = 0;
        public short hit_melee_mario = 0, avoid_melee_mario = 0, hit_ranged_mario = 0, avoid_ranged_mario = 0, avoid_magic_mario = 0, cri_mario = 0, cri_avoid_mario = 0;
        public short hp_mario = 0, sp_mario = 0, mp_mario = 0;
        public short hp_recover_mario = 0, mp_recover_mario = 0;
        ...
        /// 商人买卖相关
        /// </summary>
        public short buy_rate = 100, sell_rate = 100;
        /// <summary>
        /// 不死族状态
        /// </summary>
        public bool undead;
        ...
        /// 2转元素契约
        /// </summary>
        public Dictionary<SagaLib.Elements, byte> ElementContract = new Dictionary<SagaLib.Elements, byte>();

        /// <summary>
        /// 2-2的光明之魂和黑暗之魂, 火焰从者
        /// </summary>
        public Dictionary<SagaLib.Elements, byte> ElementSoul = new Dictionary<SagaLib.Elements, byte>();
        ...
        public ConcurrentDictionary<string, Addition> Additions = new ConcurrentDictionary<string, Addition>();
        ...
        public void ClearItem()
        {
            ...
            this.buy_rate_iris = 100;
            this.sell_rate_iris = 100;
            this.reance_speed_iris = 0;
            this.part_expup_iris = 0;//ECOKEY新增IRIS寵物經驗
            //this.min_atk1_mario = 0;
            //this.min_atk2_mario = 0;
            //this.min_atk3_mario = 0;
            //this.max_atk1_mario = 0;
            //this.max_atk2_mario = 0;
            //this.max_atk3_mario = 0;
            //this.min_matk_mario = 0;
            //this.max_matk_mario = 0;
            //this.str_mario = 0;
            //this.dex_mario = 0;
            //this.int_mario = 0;
            //this.vit_mario = 0;
            ...
            //this.mag_mario = 0;
            //this.def_mario = 0;
            //this.def_add_mario = 0;
            //this.mdef_mario = 0;
            //this.mdef_add_mario = 0;
            //this.hp_mario = 0;
            //this.sp_mario = 0;
            //this.mp_mario = 0;
            //this.hp_recover_mario = 0;
            //this.mp_recover_mario = 0;
