...
namespace SagaDB.Actor
{
    ...
    public class ActorFurniture : Actor
    {
        ...
        uint actorpartnerid;//ECOKEY 寵物專用ID
        ushort durability;//ECOKEY 寵物親密度
        ...
        /// 寵物專用ID
        /// </summary>
        public uint ActorPartnerID { get { return this.actorpartnerid; } set { this.actorpartnerid = value; } }
