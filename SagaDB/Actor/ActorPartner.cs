...
namespace SagaDB.Actor
{
    public class ActorPartner : Actor
    {
        ...
        public Dictionary<byte, byte> ai_HPs = new Dictionary<byte, byte>();
        public Dictionary<byte, byte> ai_Targets = new Dictionary<byte, byte>();
        ...
        //ECOKET 自定義AI2
        public Dictionary<byte, ushort> ai_conditions2 = new Dictionary<byte, ushort>();
        public Dictionary<byte, byte> ai_HPs2 = new Dictionary<byte, byte>();
        public Dictionary<byte, byte> ai_Targets2 = new Dictionary<byte, byte>();
        public Dictionary<byte, ushort> ai_reactions2 = new Dictionary<byte, ushort>();
        public Dictionary<byte, ushort> ai_intervals2 = new Dictionary<byte, ushort>();
        public Dictionary<byte, bool> ai_states2 = new Dictionary<byte, bool>();
        public bool CustomAI2 = false;
        public byte PlusAI = 0;//ECOKEY 自定義AI數量追加
        ...
        public ActorPartner(uint partnerid, Item.Item partneritem)
        {
            ...
            this.Speed = 780;
            //ECOKEY 騎寵速度
            if (partneritem.BaseData.itemType == ItemType.RIDE_PARTNER)
            {
        ...
        public override byte Level
        {
            ...
            set
            {
                lv = value;
                if (e != null)
                    e.PropertyUpdate(UpdateEvent.LEVEL, 1);
            }
        }
        /// <summary>
        /// 动作
