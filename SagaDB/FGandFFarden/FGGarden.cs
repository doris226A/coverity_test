...
namespace SagaDB.FGarden
{
    ...
    public class FGarden
    {
        ...
        Dictionary<string, uint> recordlist = new Dictionary<string, uint>();//ECOKEY 飛空庭的音樂列表
        ...
        /// 飛空庭的音樂
        /// </summary>
        public uint Sound { get { return this.sound; } set { this.sound = value; } }

        /// <summary>
        /// 飛空庭的音樂列表
        /// </summary>
        public Dictionary<string, uint> RecordList { get { return this.recordlist; } set { this.recordlist = value; } }
    }
}
