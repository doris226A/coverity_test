...
namespace SagaLib
{
    ...
    public static class Global
    {
        ...
        {
            private static readonly RandomF instance = new RandomF();

            private ThreadLocal<Random> random = new ThreadLocal<Random>(() => new Random(Guid.NewGuid().GetHashCode()));

            public static RandomF Instance { get { return instance; } }
