...
namespace SagaLib
{
    public class ClientManager
    {
        ...
        private static readonly object lockObj = new object();//用於同步鎖定//二哈更改1015
        ...
        {
            lock (lockObj)  // 鎖定blockThread物件的訪問防止多線競爭
            {
                ...
                try
                {
                    ...
                    enteredcriarea = true;
                    blockedThread.Add(Thread.CurrentThread);  // 將前線程加入blockedThread
                ...
                {
                    Logger.ShowError("Error entering critical area: " + ex.ToString(), Logger.defaultlogger);
                }
            }
        }
...
namespace SagaLib
{
    public class ClientManager
    {
        ...
        public static void EnterCriticalArea()
        {
            //  Logger.ShowDebug("Thread " + Thread.CurrentThread.ManagedThreadId + " attempting to enter critical area.", Logger.defaultlogger);
            ...
            else
            {
                ...
                blockdetail = "锁定线程名:" + Thread.CurrentThread.Name;
                Stacktrace = new StackTrace(1, true);
                //  Logger.ShowDebug("Thread " + Thread.CurrentThread.ManagedThreadId + " entered critical area.", Logger.defaultlogger);
            }
        }
