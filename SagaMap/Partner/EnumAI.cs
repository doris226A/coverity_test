...
namespace SagaMap.Partner
{
    ...
    {
        //ECOKEY
        public List<uint> Skills { get; set; } = new List<uint>();
        public List<ushort> EquipCubesActiveSkill { get; set; } = new List<ushort>();
        ...
        /// <summary>
        /// 寵物在攻击时，需要使用技能时的技能列表，Key＝技能，Value＝几率
        /// </summary>
        ...
        /// <summary>
        /// 寵物的主人在战斗中时，需要使用技能时的技能列表，Key＝技能，Value＝几率
        /// </summary>
