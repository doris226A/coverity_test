...
namespace SagaMap
{
    public class AtCommand : Singleton<AtCommand>
    {
        ...
        public AtCommand()
        {
            ...
            #region "ECOKEY Commands"
            commandTable.Add(GMCommandPrefix + "gopark", new CommandInfo(new ProcessCommandFunc(ProcessGoPark), 0));
            commandTable.Add(OpenCommandPrefix + "gopark", new CommandInfo(new ProcessCommandFunc(ProcessGoPark), 0));
            commandTable.Add(GMCommandPrefix + "knight", new CommandInfo(new ProcessCommandFunc(ProcessStartKnightWar), 254));//ECOKEY 開關騎士團
            commandTable.Add(GMCommandPrefix + "whomap", new CommandInfo(new ProcessCommandFunc(ProcessMapPlayer), 254));//ECOKEY 確認當前地圖人數
            commandTable.Add(GMCommandPrefix + "dye", new CommandInfo(new ProcessCommandFunc(ProcessDYE), 254));
            commandTable.Add(GMCommandPrefix + "killallmob2", new CommandInfo(new ProcessCommandFunc(ProcessKillAllMob2), 254));//ECOKEY 清除卡怪
            commandTable.Add(GMCommandPrefix + "clearai", new CommandInfo(new ProcessCommandFunc(ProcessClearAi), 254));//ECOKEY 0302卡寵修改測試
            commandTable.Add(GMCommandPrefix + "ncshoppoint", new CommandInfo(new ProcessCommandFunc(ProcessNCShoppoint), 254));
            commandTable.Add(GMCommandPrefix + "itemmapto", new CommandInfo(new ProcessCommandFunc(ProcessItemToMap), 254));
            commandTable.Add(GMCommandPrefix + "levelto", new CommandInfo(new ProcessCommandFunc(ProcessLevelexp), 254));
            commandTable.Add(GMCommandPrefix + "whomob", new CommandInfo(new ProcessCommandFunc(ProcessWhoMob), 254));
            commandTable.Add(GMCommandPrefix + "knightbuff", new CommandInfo(new ProcessCommandFunc(ProcessKnightBuff), 254));//ECOKEY 騎士團BUFF測試
            commandTable.Add(GMCommandPrefix + "killplayer", new CommandInfo(new ProcessCommandFunc(ProcessKillPlayer), 254));
            commandTable.Add(GMCommandPrefix + "odwarcheck", new CommandInfo(new ProcessCommandFunc(ProcessOdwaranother), 254));//ECOKEY 攻防戰補象徵
            commandTable.Add(GMCommandPrefix + "odwar", new CommandInfo(new ProcessCommandFunc(ProcessStartODWar), 254));//ECOKEY 開關攻防戰


            //  commandTable.Add(OpenCommandPrefix + "now", new CommandInfo(new ProcessCommandFunc(this.ProcessNow), 0));
            // commandTable.Add(GMCommandPrefix + "now", new CommandInfo(new ProcessCommandFunc(this.ProcessNow), 0));
            //ECOKEY 新增寵物相關調整
            commandTable.Add(GMCommandPrefix + "petlv", new CommandInfo(new ProcessCommandFunc(ProcessPetLevel), 254));
            commandTable.Add(GMCommandPrefix + "petrank", new CommandInfo(new ProcessCommandFunc(ProcessPetRank), 254));
            commandTable.Add(GMCommandPrefix + "petheart", new CommandInfo(new ProcessCommandFunc(ProcessPetReliability), 254));
            //ECOKEY 外掛檢查
            commandTable.Add(GMCommandPrefix + "plug", new CommandInfo(new ProcessCommandFunc(ProcessplugInTest), 254));
            commandTable.Add(GMCommandPrefix + "item3", new CommandInfo(new ProcessCommandFunc(this.ProcessItem3), 254));//ECOKEY 強化補償1
            commandTable.Add(GMCommandPrefix + "item4", new CommandInfo(new ProcessCommandFunc(this.ProcessItem4), 254));//ECOKEY 強化補償2


            //ECOKEY 新增cp和ecoin查詢
            commandTable.Add(OpenCommandPrefix + "cp", new CommandInfo(new ProcessCommandFunc(ProcessCp), 0));
            commandTable.Add(OpenCommandPrefix + "ecoin", new CommandInfo(new ProcessCommandFunc(ProcessEcoin), 0));


            //ECOKEY 爆擊機率
            commandTable.Add(OpenCommandPrefix + "hit", new CommandInfo(new ProcessCommandFunc(ProcessBuffcri), 0));
            commandTable.Add(OpenCommandPrefix + "checkfame", new CommandInfo(new ProcessCommandFunc(this.ProcessCheckFame), 0));
            #endregion

            #region "Public Commands"

            commandTable.Add(GMCommandPrefix + "buff", new CommandInfo(new ProcessCommandFunc(ProcessBuffTest), 254));
            commandTable.Add(GMCommandPrefix + "revive", new CommandInfo(new ProcessCommandFunc(ProcessRevive), 254));
            commandTable.Add(GMCommandPrefix + "home", new CommandInfo(new ProcessCommandFunc(ProcessHome), 254));

            // public commands
            commandTable.Add(OpenCommandPrefix + "who", new CommandInfo(new ProcessCommandFunc(this.ProcessWho), 254));
            ...
            commandTable.Add(OpenCommandPrefix + "user", new CommandInfo(new ProcessCommandFunc(this.ProcessUser), 254));
            commandTable.Add(OpenCommandPrefix + "commandlist", new CommandInfo(new ProcessCommandFunc(ProcessCommandList), 254));
            commandTable.Add(OpenCommandPrefix + "w", new CommandInfo(new ProcessCommandFunc(ProcessTrumpet), 254));
            commandTable.Add(OpenCommandPrefix + "openware", new CommandInfo(new ProcessCommandFunc(ProcessOpenWare), 254));
            ...
            commandTable.Add(OpenCommandPrefix + "refuse", new CommandInfo(new ProcessCommandFunc(ProcessRefuse), 254));
            commandTable.Add(OpenCommandPrefix + "acceptpk", new CommandInfo(new ProcessCommandFunc(ProcessAccept), 254));
            ...
            commandTable.Add(OpenCommandPrefix + "queryfame", new CommandInfo(new ProcessCommandFunc(this.ProcessQueryFame), 254));
            commandTable.Add(OpenCommandPrefix + "suicide", new CommandInfo(new ProcessCommandFunc(this.ProcessSuicide), 254));
            #endregion
            ...
            commandTable.Add(GMCommandPrefix + "wing", new CommandInfo(new ProcessCommandFunc(ProcessOpenWing), 254));
            commandTable.Add(GMCommandPrefix + "ffweather", new CommandInfo(new ProcessCommandFunc(ProcessChangeFFWeather), 254));
            commandTable.Add(GMCommandPrefix + "fg", new CommandInfo(new ProcessCommandFunc(ProcessFG), 254));
            commandTable.Add(GMCommandPrefix + "joinfg", new CommandInfo(new ProcessCommandFunc(ProcessJoinFG), 254));

            commandTable.Add(GMCommandPrefix + "warp", new CommandInfo(new ProcessCommandFunc(ProcessWarp), 254));
            commandTable.Add(GMCommandPrefix + "announce", new CommandInfo(new ProcessCommandFunc(ProcessAnnounce), 254));
            commandTable.Add(GMCommandPrefix + "heal", new CommandInfo(new ProcessCommandFunc(ProcessHeal), 254));
            commandTable.Add(GMCommandPrefix + "level", new CommandInfo(new ProcessCommandFunc(ProcessLevel), 254));
            commandTable.Add(GMCommandPrefix + "joblv", new CommandInfo(new ProcessCommandFunc(ProcessJobLevel), 254));
            commandTable.Add(GMCommandPrefix + "gold", new CommandInfo(new ProcessCommandFunc(ProcessGold), 254));
            commandTable.Add(GMCommandPrefix + "shoppoint", new CommandInfo(new ProcessCommandFunc(ProcessShoppoint), 254));
            commandTable.Add(GMCommandPrefix + "hair", new CommandInfo(new ProcessCommandFunc(ProcessHair), 254));
            commandTable.Add(GMCommandPrefix + "hairstyle", new CommandInfo(new ProcessCommandFunc(ProcessHairstyle), 254));
            commandTable.Add(GMCommandPrefix + "haircolor", new CommandInfo(new ProcessCommandFunc(ProcessHaircolor), 254));
            commandTable.Add(GMCommandPrefix + "job", new CommandInfo(new ProcessCommandFunc(ProcessJob), 254));
            commandTable.Add(GMCommandPrefix + "statpoints", new CommandInfo(new ProcessCommandFunc(ProcessStatPoints), 254));
            commandTable.Add(GMCommandPrefix + "skillpoints", new CommandInfo(new ProcessCommandFunc(ProcessSkillPoints), 254));
            commandTable.Add(GMCommandPrefix + "hide", new CommandInfo(new ProcessCommandFunc(ProcessHide), 254));
            commandTable.Add(GMCommandPrefix + "ban", new CommandInfo(new ProcessCommandFunc(ProcessBan), 254));

            commandTable.Add(GMCommandPrefix + "event", new CommandInfo(new ProcessCommandFunc(ProcessEvent), 254));

            commandTable.Add(GMCommandPrefix + "hairext", new CommandInfo(new ProcessCommandFunc(ProcessHairext), 254));
            commandTable.Add(GMCommandPrefix + "playersize", new CommandInfo(new ProcessCommandFunc(ProcessPlayersize), 254));
            commandTable.Add(GMCommandPrefix + "item", new CommandInfo(new ProcessCommandFunc(ProcessItem), 254));
            commandTable.Add(GMCommandPrefix + "speed", new CommandInfo(new ProcessCommandFunc(ProcessSpeed), 254));
            commandTable.Add(GMCommandPrefix + "gmrevive", new CommandInfo(new ProcessCommandFunc(ProcessRevive), 254));

            commandTable.Add(GMCommandPrefix + "kick", new CommandInfo(new ProcessCommandFunc(ProcessKick), 255));
            commandTable.Add(GMCommandPrefix + "kickall", new CommandInfo(new ProcessCommandFunc(ProcessKickAll), 254));
            commandTable.Add(GMCommandPrefix + "recall", new CommandInfo(new ProcessCommandFunc(ProcessJump), 254));
            commandTable.Add(GMCommandPrefix + "recall2", new CommandInfo(new ProcessCommandFunc(ProcessJump2), 254));
            commandTable.Add(GMCommandPrefix + "jump", new CommandInfo(new ProcessCommandFunc(ProcessJumpTo), 254));
            commandTable.Add(GMCommandPrefix + "jump2", new CommandInfo(new ProcessCommandFunc(ProcessJumpTo2), 254));
            commandTable.Add(GMCommandPrefix + "mob", new CommandInfo(new ProcessCommandFunc(ProcessMob), 254));
            commandTable.Add(GMCommandPrefix + "summon", new CommandInfo(new ProcessCommandFunc(ProcessSummon), 254));
            commandTable.Add(GMCommandPrefix + "summonme", new CommandInfo(new ProcessCommandFunc(ProcessSummonMe), 254));
            commandTable.Add(GMCommandPrefix + "spawn", new CommandInfo(new ProcessCommandFunc(ProcessSpawn), 254));
            commandTable.Add(GMCommandPrefix + "effect", new CommandInfo(new ProcessCommandFunc(ProcessEffect), 254));
            commandTable.Add(GMCommandPrefix + "kickgolem", new CommandInfo(new ProcessCommandFunc(ProcessKickGolem), 254));
            commandTable.Add(GMCommandPrefix + "killallmob", new CommandInfo(new ProcessCommandFunc(ProcessKillAllMob), 254));
            commandTable.Add(GMCommandPrefix + "odwarstart", new CommandInfo(new ProcessCommandFunc(ProcessODWarStart), 254));
            //this.commandTable.Add(GMCommandPrefix + "tweet", new CommandInfo(new ProcessCommandFunc(this.ProcessTweet), 0));


            //for skill test
            commandTable.Add(GMCommandPrefix + "skill", new CommandInfo(new ProcessCommandFunc(ProcessSkill), 254));
            commandTable.Add(GMCommandPrefix + "skillclear", new CommandInfo(new ProcessCommandFunc(ProcessSkillClear), 254));
            commandTable.Add(GMCommandPrefix + "gmob", new CommandInfo(new ProcessCommandFunc(ProcessGridMob), 254));
            commandTable.Add(GMCommandPrefix + "showstatus", new CommandInfo(new ProcessCommandFunc(ProcessShowStatus), 254));

            commandTable.Add(GMCommandPrefix + "who", new CommandInfo(new ProcessCommandFunc(ProcessWho), 254));
            commandTable.Add(GMCommandPrefix + "who2", new CommandInfo(new ProcessCommandFunc(ProcessWho2), 254));
            commandTable.Add(GMCommandPrefix + "who3", new CommandInfo(new ProcessCommandFunc(ProcessWho3), 254));
            commandTable.Add(GMCommandPrefix + "who5", new CommandInfo(new ProcessCommandFunc(ProcessWho5), 254)); //ECOKEY
            commandTable.Add(GMCommandPrefix + "mode", new CommandInfo(new ProcessCommandFunc(ProcessMode), 254));
            commandTable.Add(GMCommandPrefix + "robot", new CommandInfo(new ProcessCommandFunc(ProcessRobot), 254));

            commandTable.Add(GMCommandPrefix + "go", new CommandInfo(new ProcessCommandFunc(ProcessGo), 254));
            commandTable.Add(GMCommandPrefix + "ch", new CommandInfo(new ProcessCommandFunc(ProcessCh), 254));
            //now working
            commandTable.Add(GMCommandPrefix + "info", new CommandInfo(new ProcessCommandFunc(ProcessInfo), 254));

            commandTable.Add(GMCommandPrefix + "reloadscript", new CommandInfo(new ProcessCommandFunc(ProcessReloadScript), 254));
            commandTable.Add(GMCommandPrefix + "reloadconfig", new CommandInfo(new ProcessCommandFunc(ProcessReloadConfig), 254));
            commandTable.Add(GMCommandPrefix + "raw", new CommandInfo(new ProcessCommandFunc(ProcessRaw), 254));
            commandTable.Add(GMCommandPrefix + "test", new CommandInfo(new ProcessCommandFunc(ProcessTest), 254));

            commandTable.Add(GMCommandPrefix + "face", new CommandInfo(new ProcessCommandFunc(ProcessFace), 254));
            commandTable.Add(GMCommandPrefix + "createff", new CommandInfo(new ProcessCommandFunc(ProcessCreateFF), 254));
            commandTable.Add(GMCommandPrefix + "openff", new CommandInfo(new ProcessCommandFunc(ProcessOpenFF), 254));

            commandTable.Add(GMCommandPrefix + "theater", new CommandInfo(new ProcessCommandFunc(ProcessTheater), 254));

            commandTable.Add(GMCommandPrefix + "metamo", new CommandInfo(new ProcessCommandFunc(ProcessMetamo), 254));

            commandTable.Add(GMCommandPrefix + "through", new CommandInfo(new ProcessCommandFunc(ProcessThrough), 254));

            commandTable.Add(GMCommandPrefix + "ta", new CommandInfo(new ProcessCommandFunc(ProcessTaskAnnounce), 254));
            commandTable.Add(GMCommandPrefix + "sta", new CommandInfo(new ProcessCommandFunc(ProcessStopTaskAnnounce), 254));

            commandTable.Add(GMCommandPrefix + "goldto", new CommandInfo(new ProcessCommandFunc(ProcessGoldTo), 254));
            commandTable.Add(GMCommandPrefix + "itemto", new CommandInfo(new ProcessCommandFunc(ProcessItemTo), 254));

            commandTable.Add(GMCommandPrefix + "ring", new CommandInfo(new ProcessCommandFunc(ProcessRing), 254));

            commandTable.Add(GMCommandPrefix + "clearbuff", new CommandInfo(new ProcessCommandFunc(ProcessClearBuff), 254));

            //简化操作！！
            commandTable.Add(GMCommandPrefix + "var", new CommandInfo(new ProcessCommandFunc(ProcessVariable), 254));
            commandTable.Add(GMCommandPrefix + "variable", new CommandInfo(new ProcessCommandFunc(ProcessVariable), 254));
            commandTable.Add(GMCommandPrefix + "title", new CommandInfo(new ProcessCommandFunc(ProcessSetTitle), 254));
            commandTable.Add(GMCommandPrefix + "titleto", new CommandInfo(new ProcessCommandFunc(ProcessSetTitleTo), 254));
            commandTable.Add(GMCommandPrefix + "status", new CommandInfo(new ProcessCommandFunc(ProcessStatus), 254));
            commandTable.Add(GMCommandPrefix + "effect2", new CommandInfo(new ProcessCommandFunc(ProcessEffect2), 254));

            commandTable.Add(GMCommandPrefix + "golem", new CommandInfo(new ProcessCommandFunc(ProcessGolem), 254));
            commandTable.Add(GMCommandPrefix + "debug", new CommandInfo(new ProcessCommandFunc(ProcessDebug), 254));
            commandTable.Add(GMCommandPrefix + "dialog", new CommandInfo(new ProcessCommandFunc(ProcessDialog), 254));

            commandTable.Add(GMCommandPrefix + "idsearch", new CommandInfo(new ProcessCommandFunc(this.ProcessIDSearch), 254));
            commandTable.Add(GMCommandPrefix + "equiplist", new CommandInfo(new ProcessCommandFunc(this.ProcessEquipList), 254));
            commandTable.Add(GMCommandPrefix + "inventorylist", new CommandInfo(new ProcessCommandFunc(this.ProcessInventoryList), 254));
            commandTable.Add(GMCommandPrefix + "recallmap", new CommandInfo(new ProcessCommandFunc(this.ProcessCallMap), 254));
            commandTable.Add(GMCommandPrefix + "recallall", new CommandInfo(new ProcessCommandFunc(this.ProcessCallAll), 254));
            commandTable.Add(GMCommandPrefix + "monsterinfo", new CommandInfo(new ProcessCommandFunc(this.ProcessMonsterInfo), 254));
            commandTable.Add(GMCommandPrefix + "reloadskilldb", new CommandInfo(new ProcessCommandFunc(this.ProcessReloadSkillDB), 254));
            commandTable.Add(GMCommandPrefix + "skillall", new CommandInfo(new ProcessCommandFunc(this.ProcessSkillALL), 254));
            commandTable.Add(GMCommandPrefix + "fame", new CommandInfo(new ProcessCommandFunc(this.ProcessFame), 254));
            commandTable.Add(GMCommandPrefix + "statreset", new CommandInfo(new ProcessCommandFunc(this.ProcessStatReset), 254));
            commandTable.Add(GMCommandPrefix + "skreset", new CommandInfo(new ProcessCommandFunc(this.ProcessSkillReset), 254));
            commandTable.Add(GMCommandPrefix + "rwarp", new CommandInfo(new ProcessCommandFunc(this.ProcessRWarp), 254));
            commandTable.Add(GMCommandPrefix + "ep", new CommandInfo(new ProcessCommandFunc(this.ProcessEP), 254));
            #endregion

            #region 黑白照Addition
            commandTable.Add(GMCommandPrefix + "item2", new CommandInfo(new ProcessCommandFunc(this.ProcessItem2), 254));
            commandTable.Add(GMCommandPrefix + "itemclear", new CommandInfo(new ProcessCommandFunc(this.ProcessItemClear), 254));
            commandTable.Add(GMCommandPrefix + "irissearch", new CommandInfo(new ProcessCommandFunc(this.ProcessIrisSearch), 254));
            #endregion

            #region KK測試用
            commandTable.Add(GMCommandPrefix + "mapobj", new CommandInfo(new ProcessCommandFunc(this.ProcessMapObject), 254));
            commandTable.Add(GMCommandPrefix + "ssmode", new CommandInfo(new ProcessCommandFunc(this.ProcessSSMode), 254));
            commandTable.Add(GMCommandPrefix + "aaavoice", new CommandInfo(new ProcessCommandFunc(this.ProcessAAVoice), 254));
            commandTable.Add(GMCommandPrefix + "npcvoice", new CommandInfo(new ProcessCommandFunc(this.ProcessNPCVoice), 254));
            commandTable.Add(GMCommandPrefix + "raw2", new CommandInfo(new ProcessCommandFunc(ProcessRaw2), 254));
            commandTable.Add(GMCommandPrefix + "pmotion", new CommandInfo(new ProcessCommandFunc(ProcessPartnerMotion), 254));
            commandTable.Add(GMCommandPrefix + "cleards", new CommandInfo(new ProcessCommandFunc(ProcessClearDS), 254));
            commandTable.Add(GMCommandPrefix + "actortalk", new CommandInfo(new ProcessCommandFunc(ProcessActorTalk), 254));
        ...
        void ProcessKillPlayer(MapClient client, string playername)
        {
                ...
                else
                {
                    try
                    {
                        // 查找名稱為 playername 的在線玩家
                        var targetPlayer = MapClientManager.Instance.OnlinePlayer
                                           .FirstOrDefault(c => c.Character.Name == playername);

                        // 如果找不到該玩家，發送錯誤信息給指令執行者
                        if (targetPlayer == null)
                        {
                            client.SendSystemMessage("Player not found.");
                            return;
                        }

                        // 檢查該玩家是否為 PC 類型，並讓其角色死亡
                        if (targetPlayer.Character.type == ActorType.PC)
                        {
                            ActorEventHandlers.PCEventHandler targetEventHandler =
                                (PCEventHandler)targetPlayer.Character.e;

                            // 設置指定玩家的 Buff 狀態為假死（PlayingDead）
                            targetPlayer.Character.Buff.PlayingDead = true;

                            // 觸發死亡處理
                            targetEventHandler.OnDie();

                            // 發送成功訊息給指令執行者
                            client.SendSystemMessage($"{playername} has been killed.");
                        }
                    }
                    catch (Exception ex)
                    {
                        // 處理任何可能的異常
                        client.SendSystemMessage("An error occurred while trying to kill the player.");
                    }
            }
            ...
            else
            {
                try
                {
                    ...
                    select c;
                    if (client.Character.type == ActorType.PC)
                    {
                        ActorEventHandlers.PCEventHandler eh = (PCEventHandler)client.Character.e;
                        client.Character.Buff.PlayingDead = true;
                        eh.OnDie();
                        //count++;
                    }
                }
    ...
    select c;
        ...
        private void ProcessDYE(MapClient client, string args)
        {
                string name;
                byte number;
                uint id = 0;
                ...
                try
                {
                    ...
                    number = byte.Parse(args.Split(' ')[2]);
            ...
            /*  private void ProcessNow(MapClient client, string args)
              {
        ...
        public void ProcessThrough(MapClient client, string args)
        {
            try
            {
                ...
                else
                {
                    ...
                    client.Character.Status.Additions.TryRemove("Through", out _);
                }
            }
            catch { }
        }
        ...
        public void ProcessDialog(MapClient client, string command)
        {
            try
            {
                ...
                if (args.Length == 1)
                {
                    ...
                    Packets.Server.SSMG_AA_DIALOG_BOX p = new Packets.Server.SSMG_AA_DIALOG_BOX();
                    p.DID = ID;
                    client.netIO.SendPacket(p);
                }
            }
            ...
            try
            {
                switch (args.ToLower())
                {
                    ...
                    case "skilldb":
                        ...
                        break;
                    case "sagamap":
                        ProcessSettingAnnounce(client, "[系统] 系统配置更新中...");
                        Configuration.Instance.Initialization("./Config/SagaMap.xml");
                        ProcessSettingAnnounce(client, "[系统] 系统配置更新完成");
                        break;
                    case "odwar":
                        ProcessSettingAnnounce(client, "[系统] ODWAR配置更新中...");
                        ODWarFactory.Instance.Reload();
                        ODWarFactory.Instance.Init("DB/ODWar.xml", System.Text.Encoding.GetEncoding(Configuration.Instance.DBEncoding));
                        ProcessSettingAnnounce(client, "[系统] ODWAR配置更新完成");
                        break;
                    case "knightwar":
                        //ECOKEY 騎士團
                        ProcessSettingAnnounce(client, "[系统] knightwar配置更新中...");
                        KnightWarFactory.Instance.Reload();
                        KnightWarFactory.Instance.Init("DB/KnightWar.xml", System.Text.Encoding.GetEncoding(Configuration.Instance.DBEncoding));
                        ProcessSettingAnnounce(client, "[系统] knightwar配置更新完成");
                        break;
                    default:
        ...
        private void ProcessLevelexp(MapClient client, string args)
        {
            if (args == "")
            {
            ...
            else
            {
                try
                {
                    ...
                    byte type = byte.Parse(args.Split(' ')[1]);
                    byte lv = byte.Parse(args.Split(' ')[2]);
                    ulong exp = ulong.Parse(args.Split(' ')[3]);
                    MapClient cp = (MapClient)SagaMap.Manager.MapClientManager.Instance.GetClientForName(name);
                    ulong AA = 0;
                    ulong BB = 0;
                    ulong CC = 0;
                    ...
                    if (cp != null)
                    {
                        if (type == 0)
                        {
                            if (!cp.Character.Rebirth)
                            {
                                AA = ExperienceManager.Instance.GetExpForLevel(lv, SagaMap.Scripting.LevelType.CLEVEL);
                                BB = ExperienceManager.Instance.GetExpForLevel((uint)(lv + 1), SagaMap.Scripting.LevelType.CLEVEL);
                                CC = BB - AA;
                                DD = exp * CC / 100 + AA;
                                cp.Character.CEXP = DD;
                            }
                            else
                            {
                                AA = ExperienceManager.Instance.GetExpForLevel(lv, SagaMap.Scripting.LevelType.CLEVEL2);
                                BB = ExperienceManager.Instance.GetExpForLevel((uint)(lv + 1), SagaMap.Scripting.LevelType.CLEVEL2);
                                CC = BB - AA;
                                DD = exp * CC / 100 + AA;
                                cp.Character.CEXP = DD;
                            }
                            client.SendSystemMessage("已調整" + cp.Character.Name + "的等級：" + lv + "，經驗：" + exp);
                            cp.Character.Level = lv;
                        }
                        else if (type == 1)
                        {
                            if (cp.Character.Job == cp.Character.Job2T)
                            {
                                AA = ExperienceManager.Instance.GetExpForLevel(lv, SagaMap.Scripting.LevelType.JLEVEL2);
                                BB = ExperienceManager.Instance.GetExpForLevel((uint)(lv + 1), SagaMap.Scripting.LevelType.JLEVEL2);
                                cp.Character.JobLevel2T = lv;
                            }
                            else if (cp.Character.Job == cp.Character.Job2X)
                            {
                                AA = ExperienceManager.Instance.GetExpForLevel(lv, SagaMap.Scripting.LevelType.JLEVEL2);
                                BB = ExperienceManager.Instance.GetExpForLevel((uint)(lv + 1), SagaMap.Scripting.LevelType.JLEVEL2);
                                cp.Character.JobLevel2X = lv;
                            }
                            else if (cp.Character.Job == cp.Character.JobBasic)
                            {
                                AA = ExperienceManager.Instance.GetExpForLevel(lv, SagaMap.Scripting.LevelType.JLEVEL);
                                BB = ExperienceManager.Instance.GetExpForLevel((uint)(lv + 1), SagaMap.Scripting.LevelType.JLEVEL);
                                cp.Character.JobLevel1 = lv;
                            }
                            CC = BB - AA;
                            DD = exp * CC / 100 + AA;
                            cp.Character.JEXP = DD;
                            client.SendSystemMessage("已調整" + cp.Character.Name + "的職業等級：" + lv + "，經驗：" + exp);
                    ...
                    {
                        client.SendSystemMessage("找不到指定玩家");
                    }
                }
                catch (Exception) { }
            }
        ...
        //ECOKEY 新指令，整段覆蓋
        void ProcessWhoMob(MapClient client, string arg)
        {
            if (arg == "0")
            {
                client.SendSystemMessage("1是查詢null怪");
                client.SendSystemMessage("2是清地圖怪");
                client.SendSystemMessage("3是大範圍清怪");
                client.SendSystemMessage("4是強制收寵物");
                client.SendSystemMessage("5是刪除所有地上的道具");
                client.SendSystemMessage("6是查詢目前有的地牢");
                client.SendSystemMessage("7是刪除沒人的地牢（副本）");
                client.SendSystemMessage("8是全世界怪物在兩個TASK執行後清除");
                client.SendSystemMessage("9是清除全世界死怪");
                client.SendSystemMessage("10是清除全世界怪物的狀態");
                client.SendSystemMessage("666是除了Respawn的AI世界清怪");
                client.SendSystemMessage("6662是TASK世界清怪");
                client.SendSystemMessage("6661是清怪AI");
                client.SendSystemMessage("888是清除所有Task，確定要重啟時使用");
            }
            if (arg == "1")
            {
                ...
                foreach (MapClient i in MapClientManager.Instance.OnlinePlayer)
                {
                    if (!maps.Contains(i.Map.ID))
                    {
                        maps.Add(i.Map.ID);
                    }
                }
                int count = 0;
                foreach (uint m in maps)
                {
                    List<Actor> actors = Manager.MapManager.Instance.GetMap(m).Actors.Values.ToList();
                    foreach (Actor i in actors)
                    {
                        if (i == null)
                        {
                            client.SendSystemMessage("對象出錯 請回報，地圖ID為" + m.ToString());
                            count++;
                            continue;
                        }
                    }
                }
                client.SendSystemMessage(count.ToString() + " 出錯");
            }
            if (arg == "2")
            {
                int count = 0;
                ...
                foreach (Actor act in actors)
                {
                    ...
                    if (act == null)
                    {
                        client.SendSystemMessage("有null怪 先略");
                        continue;
                    }
                    switch (act.type)
                    {
                        case ActorType.MOB:
                            ...
                            ActorEventHandlers.MobEventHandler eh = (MobEventHandler)mob.e;
                            Manager.MapManager.Instance.GetMap(mob.MapID).DeleteActor(mob);
                            mob.ClearTaskAddition();
                            if (!mob.Tasks.ContainsKey("Respawn"))
                            {
                                if (eh.AI.SpawnDelay != 0)
                                {
                                    Tasks.Mob.Respawn respawn = new SagaMap.Tasks.Mob.Respawn(mob, eh.AI.SpawnDelay);
                                    mob.Tasks.Add("Respawn", respawn);
                                    respawn.Activate();
                                    count++;
                                }
                            }
                            eh.AI.firstAttacker = null;
                            mob.Status.attackingActors.Clear();
                            eh.AI.DamageTable.Clear();
            ...
            {
                int count = 0;
                Map map = Manager.MapManager.Instance.GetMap(client.Character.MapID);
                List<Actor> affected = map.GetActorsArea(client.Character, 5000, false);
            ...
            if (arg == "4")
            {
                ...
                foreach (MapClient i in MapClientManager.Instance.OnlinePlayer)
                {
                    ActorPC pc = i.Character;
                    if (pc.Inventory.Equipments.ContainsKey(EnumEquipSlot.PET) && pc.Partner != null)
                    {
                        foreach (string u in pc.Partner.Tasks.Keys.ToArray())
                        {
                            pc.Partner.Tasks[u].Deactivate();
                            pc.Partner.Tasks.Remove(u);
                        }
                        ...
                        try
                        {
                            ...
                            {
                                SagaDB.Item.Item item = pc.Inventory.Equipments[EnumEquipSlot.PET];
                ...
                client.SendSystemMessage(count.ToString() + " 收起寵物");
            }
            if (arg == "5")
            {
                List<uint> maps = new List<uint>();
                ...
                foreach (uint m in maps)
                {
                    Map mapA = Manager.MapManager.Instance.GetMap(m);
                    List<Actor> actors = mapA.Actors.Values.ToList();
                    foreach (Actor i in actors)
                    {
                        if (i == null)
                        {
                ...
                client.SendSystemMessage(count.ToString() + " 清理");
            }
            if (arg == "6")
            {
                SagaMap.Dungeon.Dungeon dungeon;

                foreach (uint a in SagaMap.Dungeon.DungeonFactory.Instance.GetALLDungeon().Keys)
                {
                    bool check = false;
                    dungeon = SagaMap.Dungeon.DungeonFactory.Instance.GetDungeon(a);
                    foreach (SagaMap.Dungeon.DungeonMap i in dungeon.Maps)
                    {
                        foreach (Actor o in i.Map.Actors.Values)
                        {
                            if (o.type == ActorType.PC)
                            {
                                client.SendSystemMessage(a + "  是地牢，這地牢有人");
                                check = true;
                                break;
                            }
                        }
                    ...
                    if (!check)
                    {
                        client.SendSystemMessage(a + "  是地牢，這地牢沒人");
                        break;
                    }
                }
            }
            if (arg == "7")
            {
                ...
                foreach (uint a in SagaMap.Dungeon.DungeonFactory.Instance.GetALLDungeon().Keys)
                {
                    ...
                    if (!check)
                    {
                        client.SendSystemMessage(a + "  是地牢，這地牢沒人，已清除");
                        foreach (SagaMap.Dungeon.DungeonMap i in dungeon.Maps)
                        {
                            SagaMap.Manager.MapManager.Instance.DeleteMapInstance(i.Map.ID);
                            i.Map.DungeonMap = null;
                            i.Map = null;
                        }
                        dungeon.Maps.Clear();
                        SagaMap.Dungeon.DungeonFactory.Instance.RemoveDungeon(a);
                        break;
                    }
                }
            }
                ...
                foreach (uint m in maps)
                {
                    ...
                    foreach (Actor i in actors)
                    {
                        ...
                        if (i.type == ActorType.MOB)
                        {
                            ...
                            ActorEventHandlers.MobEventHandler eh = (MobEventHandler)mob.e;
                            if (mob.Tasks.ContainsKey("DeleteCorpse"))
                            {
                                mob.Tasks.Remove("DeleteCorpse");
                                Manager.MapManager.Instance.GetMap(mob.MapID).DeleteActor(mob);
                                mob.Tasks["DeleteCorpse"].Deactivate();
                            }
                            eh.AI.firstAttacker = null;
                            mob.Status.attackingActors.Clear();
                            eh.AI.DamageTable.Clear();
            ...
            if (arg == "9")
            {
                ...
                foreach (uint m in maps)
                {
                    ...
                    foreach (Actor i in actors)
                    {
                        ...
                        if (i.type == ActorType.MOB && i.Buff.Dead)
                        {
                            ActorEventHandlers.MobEventHandler eh = (MobEventHandler)i.e;
                            ActorMob mob = (ActorMob)i;
                            Manager.MapManager.Instance.GetMap(mob.MapID).DeleteActor(mob);
                ...
                client.SendSystemMessage(count.ToString() + " 清理死怪");
                ...
                foreach (uint m in maps)
                {
                    ...
                    foreach (Actor i in actors)
                    {
                        ...
                        if (i.type == ActorType.MOB)
                        {
                            ActorMob mob = (ActorMob)i;
                            ActorEventHandlers.MobEventHandler eh = (MobEventHandler)mob.e;
                            foreach (string u in mob.Tasks.Keys.ToArray())
                            {
                                if (u != "Respawn")
                                {
                                    mob.Tasks[u].Deactivate();
                                    mob.Tasks.Remove(u);
                                }
                            }
                            eh.AI.Pause();
            ...
            if (arg == "6661")
            {
                ...
                client.SendSystemMessage(count.ToString() + " 清理後再開");
            }
            ...
            if (arg == "888")
            {
                ...
                client.SendSystemMessage("清除所有Task");
            }
        }
        ...
        private void ProcessActorTalk(MapClient client, string args)
        {
            string[] arg = args.Split(' ');
            if (arg[0] == "" || arg[1] == "")
            {
                client.SendSystemMessage("請輸入正確ActorID 及 對白");
            }
            else
            {
                ...
                Actor actor = client.map.GetActor(uint.Parse(arg[0]));

                ChatArg chat = new ChatArg();
                chat.content = arg[1];
                Manager.MapManager.Instance.GetMap(actor.MapID).SendEventToAllActorsWhoCanSeeActor(Map.EVENT_TYPE.CHAT, chat, actor, true);
            }
        }
        ...
        private void ProcessItemToMap(MapClient client, string args)//ECOKEY 1002更新
        {
            uint name;
            int number;
            uint id = 0;
            ...
            try
            {
                name = uint.Parse(args.Split(' ')[0]);
                id = uint.Parse(args.Split(' ')[1]);
                number = int.Parse(args.Split(' ')[2]);
                foreach (Actor j in SagaMap.Manager.MapManager.Instance.GetMap(name).Actors.Values)
                {
                    if (j.type == ActorType.PC)
                    {
                        ActorPC pp = (ActorPC)j;
                        MapClient cp = (MapClient)SagaMap.Manager.MapClientManager.Instance.GetClientForName(pp.Name);
                        Item item = ItemFactory.Instance.GetItem(id);
                        if (item != null)
                        {
                            item.Stack = (ushort)number;
                            ...
                            cp.AddItem(item, true);
                            client.SendSystemMessage("给" + pp.Name + " " + item.BaseData.name.ToString() + " " + number.ToString() + " 个");
                        }
                        else
                        {
                            client.SendSystemMessage("失敗，正確用法：!itemmapto 地圖ID 道具ID 數量");
                            return;
                        }
                    }
                }
        ...
        private void ProcessItem3(MapClient client, string args)//ECOKEY 強化補償1
        {
            int number = 0;
            uint id = 0;
            uint picid = 0;
                ...
                try
                {
                    ...
                    switch (args.Split(' ').Length)
                    {
                        ...
                        case 8:
                            ...
                            number = int.Parse(args.Split(' ')[1]);
                            refine = int.Parse(args.Split(' ')[2]);
                            carslot = int.Parse(args.Split(' ')[3]);
                            lifeench = int.Parse(args.Split(' ')[4]);
                            powerench = int.Parse(args.Split(' ')[5]);
                            critench = int.Parse(args.Split(' ')[6]);
                            magench = int.Parse(args.Split(' ')[7]);
                            break;
                        default:
                            client.SendSystemMessage("失敗，正確用法：!item3 道具ID 數量 強化次數 開洞數量 生命 力量 會心 魔力");
                            break;
                    }
        ...
        private void ProcessItem4(MapClient client, string args)//ECOKEY 強化補償2
        {
            int number = 0;
            uint id = 0;
            uint picid = 0;
                ...
                try
                {
                    ...
                    switch (args.Split(' ').Length)
                    {
                        case 11:
                            ...
                            refine = int.Parse(args.Split(' ')[2]);
                            carslot = int.Parse(args.Split(' ')[3]);
                            hp = short.Parse(args.Split(' ')[4]);
                            def = short.Parse(args.Split(' ')[5]);
                            mdef = short.Parse(args.Split(' ')[6]);
                            atk = short.Parse(args.Split(' ')[7]);
                            matk = short.Parse(args.Split(' ')[8]);
                            ch = short.Parse(args.Split(' ')[9]);
                            ac = short.Parse(args.Split(' ')[10]);
                            break;
                        case 12:
                            id = uint.Parse(args.Split(' ')[0]);
                            number = int.Parse(args.Split(' ')[1]);
                            ...
                            break;
                        default:
                            client.SendSystemMessage("失敗，正確用法：!item4 道具ID 數量 強化次數 開洞數量 HP 防禦 魔防 攻擊 魔攻 會心 防會心");
                            break;
                    }
                    ...
                    if (item != null)
                    {
                        ...
                        item.Def = def;
                        item.MDef = mdef;
                        item.Atk1 = item.Atk2 = item.Atk3 = atk;
                        item.MAtk = matk;
                        item.HitCritical = ch;
                        item.AvoidCritical = ac;
                        if (picid != 0)
                        {
                            item.PictID = picid;
                        }
        ...
        private void ProcessWho5(MapClient client, string args)
        {
            foreach (MapClient i in MapClientManager.Instance.OnlinePlayer)
            {
                byte x, y;
                x = Global.PosX16to8(i.Character.X2, i.map.Width);
                y = Global.PosY16to8(i.Character.Y2, i.map.Height);
        ...
        //ECOKEY 開關騎士團
        private void ProcessStartKnightWar(MapClient client, string command)
        {
            try
            {
                if (Tasks.System.KnightWar.Instance.Activated == false)
                {
                    client.SendSystemMessage("開啟騎士團");
                    Tasks.System.KnightWar.Instance.Activate();
                }
                else
                {
                    client.SendSystemMessage("關閉騎士團");
        ...
        //ECOKEY 開關攻防戰
        private void ProcessStartODWar(MapClient client, string command)
        {
            if (Tasks.System.ODWar.Instance.Activated == false)
            {
                client.SendSystemMessage("開啟攻防戰");
                Tasks.System.ODWar.Instance.Activate();
            }
            else
            {
                client.SendSystemMessage("關閉攻防戰");
                Tasks.System.ODWar.Instance.Deactivate();
            }
        }
        //ECOKEY 確認當前地圖人數(活人死人分開)
        private void ProcessMapPlayer(MapClient client, string args)
        {
            int num = 0;
            int num2 = 0;
            foreach (MapClient i in MapClientManager.Instance.OnlinePlayer)
            {
                if (i.Character.MapID == client.Character.MapID)
                {
                    if (i.Character.Account.GMLevel <= 0)
                    {
                        if (i.Character.HP == 0)
                        {
                            num2++;
            ...
            client.SendSystemMessage("此地圖玩家活人數：" + num.ToString() + "此地圖玩家死人數：" + num2.ToString());
        }
        ...
        private void ProcessHaircolor(MapClient client, string args)
        {
            ...
            else
            {
                try
                {
                    ...
                    {
                        client.Character.HairColor = (byte)style;
                        client.SendCharInfoUpdate();
                        //switch (args)
                        //{
                        //    case "1":
        ...
        private void ProcessNCShoppoint(MapClient client, string args)
        {
            if (args == "")
            {
                client.SendSystemMessage(LocalManager.Instance.Strings.ATCOMMAND_SHOPPOINT_PARA);
            ...
            else
            {
                ...
                {
                    uint shopp = uint.Parse(args);
                    client.Character.NCShopPoints = shopp;
        ...
        private void ProcessGoPark(MapClient client, string command)
        {
            try
            {
                uint Event = 90010529;
        ...
        private void ProcessSettingAnnounce(MapClient client, string args)
        {
            ...
            else
            {
                try
                {
                    foreach (MapClient i in MapClientManager.Instance.OnlinePlayer)
                    {
                        if (i.Character.Account.GMLevel >= 99)
                            i.SendAnnounce(args);
                    }
        ...
        private void ProcessSuicide(MapClient client, string args)
        {
            ActorPC pc = client.Character;
        ...
        private void ProcessAutoLock(MapClient client, string args)
        {
            if (client.Character.CInt["自动锁定模式"] == 0)
            {
                ...
                client.SendSystemMessage("自動鎖定模式開啟！沒有鎖定目標時，將會自動尋找周圍目標鎖定。");
            }
            else
            {
                client.Character.CInt["自动锁定模式"] = 0;
                client.SendSystemMessage("自動鎖定模式關閉。");
            }
        }
        ...
        private void ProcessInventoryList(MapClient client, string args)
        {
            ...
            if (list.Count > 0)
            {
                client.SendSystemMessage("-------------[身体清单: " + list.Count + " 个]--------------");
                foreach (var item in list)
                {
                    if (item.ItemID != 0)
                        client.SendSystemMessage(string.Format("{0}: {1}   堆叠:{2}   价值:{3}   位置: {4}    耐久: {5}/{6}", ItemFactory.Instance.Items[item.ItemID].name, item.ItemID, item.Stack, ItemFactory.Instance.Items[item.ItemID].price, item.Slot, item.Durability, item.maxDurability));
                }
            }
        ...
        private void ProcessMonsterInfo(MapClient client, string args)
        {
            ...
            else
            {
                ...
                if (md != null)
                {
                    ...
                    client.SendSystemMessage(string.Format("等级:{0} 范围:{1} 种族:{2}[{3}] BOSS:{4} 飞行:{5}", md.level, md.range, md.race.description(), md.mobType, md.mobType.ToString().Contains("BOSS"), md.fly));
                    ...
                    client.SendSystemMessage(string.Format("防御属性值[ 无:{0} 火:{1} 水:{2} 风:{3} 地:{4} 光:{5} 暗:{6} ]", md.elements[Elements.Neutral], md.elements[Elements.Fire], md.elements[Elements.Water], md.elements[Elements.Wind], md.elements[Elements.Earth], md.elements[Elements.Holy], md.elements[Elements.Dark]));
                    ...
                    client.SendSystemMessage(string.Format("物理防御:{0}-{1} 魔法防御:{2}-{3},回避:{4}-{5}", md.def, md.def_add, md.mdef, md.mdef_add, md.avoid_melee, md.avoid_ranged));
                    client.SendSystemMessage(string.Format("暴击发动:{0} 暴击回避:{1}", md.cri, md.criavd));
                    ...
                    else
                    {
                        ...
                        {
                            var dropitemid = md.dropItems[i].ItemID.ToString();
                            if (dropitemid == "0")
                                dropitemid = "10000000";

                            var dropitemname = ItemFactory.Instance.Items.FirstOrDefault(x => x.Key == uint.Parse(dropitemid)).Value.name;


                            if (dropitemid == "10000000")
                                if (md.dropItems[i].TreasureGroup != null)
                                    dropitemname = md.dropItems[i].TreasureGroup;

                            if (dropitemid == "10000000")
                                if (md.dropItems[i].TreasureGroup != null)
                                    dropitemid = "宝箱组";

                            client.SendSystemMessage(string.Format("掉落{0}: {1}|{2} - {3}%", i + 1, dropitemid, dropitemname, (float)(md.dropItems[i].Rate / 100.0f)));
                        }
                    }
                    ...
                    else
                    {
                        ...
                        {
                            var dropitemid = md.dropItemsSpecial[i].ItemID.ToString();
                            if (dropitemid == "0")
                                dropitemid = "10000000";
                            ...
                            if (dropitemid == "10000000")
                                if (md.dropItemsSpecial[i].TreasureGroup != null)
                                    dropitemname = md.dropItemsSpecial[i].TreasureGroup;

                            if (dropitemid == "10000000")
                                if (md.dropItemsSpecial[i].TreasureGroup != null)
                                    dropitemid = "宝箱组";

                            client.SendSystemMessage(string.Format("掉落{0}: {1}|{2} - {3}%", i + 1, dropitemid, dropitemname, (float)(md.dropItemsSpecial[i].Rate / 100.0f)));
                        }
                    }
        ...
        private void ProcessRaw(MapClient client, string args)
        {
            if (args == "")
                ...
                args = "23 e4 00 00 00 01 00 00 00 00 1e 00 01 00 00 6b 6e 32 03 00 03 00";
        ...
        private void ProcessRaw2(MapClient client, string args)
        {
            if (args == "")
                //args = "12 0C 00 00 01 F4 32 32 00 32 02 00 00 00 00 00 00 00 00 50 00 00 00 50";
                args = "02 b3 14 03 b1 00 01 ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff 14 01 2e 00 01 ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff 14 00 a3 ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff 14 ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 14 32 32 32 32 32 33 33 ff ff ff ff ff ff ff ff ff ff ff ff ff";
            //args = "19 64 05 00 b7 43 4c 00 b7 43 4b 00 b7 43 4a 00 b7 43 49 00 b7 43 48 05 02 02 02 02 02 05 21 e3 81 88 e3 82 93 e3  81 a9 e3 81 86 e8 b1 86  e3 82 92 e6 8e a1 e5 8f 96 e3 81 9b e3 82 88 ef bc 81 33 e4 bf ba e3 81  ab e7 a0 82 e7 b3 96 e5 85 a5 e3 82 8a e3 82 b3 e3 83 bc e3 83 92 e3 83 bc e3 82 92 e5 85 a5 e3 82 8c e3 81 a6 e3 81 8f e3 82 8c ef bc 81 2d e3  82 a8 e3 83 8d e3 83 ab e3 82 ae e3 83 bc e3 83 89 e3 83 aa e3 83 b3 e3 82 af e3 81 8c e9 a3 b2 e3 81 bf e3 81 9f e3 81 84 ef bc 81 2a e3 83 9e e3 82 b8 e3 83 83 e3 82 af e3 83 89 e3 83 aa e3 83 b3 e3 82 af e3 81 8c e9 a3 b2 e3 81 bf e3 81 9f e3 81 84 ef bc 81 2a e3 81 8a e3 81 84 e3 81 97 e3 81 84 e3 82 ab e3 83 ac e3 83 bc e3 82 92 e4 bd 9c e3 81 a3 e3 81 a6 e3 81 8f e3 82 8c ef bc 81 05 00 00 03 84 00 00 03 84 00 00 03 84 00 00 03 84 00 00 03 84 05 2c 2c 27 22 1d";
        ...
        private void ProcessTest(MapClient client, string args)
        {
            ...
            Packets.Server.SSMG_AAA_GROUP_SEND_GROUP_STATE p = new Packets.Server.SSMG_AAA_GROUP_SEND_GROUP_STATE();
            p.AAAGroupID = 1;
            p.GroupSize = 1;
            p.GroupType = 1;
            client.netIO.SendPacket(p);
            ...
            var p1 = new Packets.Server.SSMG_STORY_SEND_STAGE_LIST_HEAD();
            client.netIO.SendPacket(p1);
            ...
            Packets.Server.SSMG_STORY_STAGE_LIST p2 = new Packets.Server.SSMG_STORY_STAGE_LIST();
            ...
            Packets.Server.SSMG_STORY_GROUP_WINDOW_OPEN p3 = new Packets.Server.SSMG_STORY_GROUP_WINDOW_OPEN();
            p3.Type = 02;
            p3.UnknowWord = 0xFF;
            p3.StageID = 2000000;
            p3.Unknow2 = 0x00;
        ...
        //ECOKEY 新增寵物相關調整
        private void ProcessPetLevel(MapClient client, string args)
        {
            if (client.Character.Partner == null)
            {
                client.SendSystemMessage("請叫出寵物");
            }
            else
            {
                if (args == "")
                {
                    client.SendSystemMessage("請輸入等級");
                }
                else
                {
                    try
                    {
                        byte lv = byte.Parse(args);
                        client.Character.Partner.Level = lv;
                        client.SendPetBasicInfo();
                    }
                    catch (Exception) { }
                }
            }
        ...
        //ECOKEY 新增寵物相關調整
        private void ProcessPetRank(MapClient client, string args)
        {
            if (client.Character.Partner == null)
            {
                client.SendSystemMessage("請叫出寵物");
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        byte lv = byte.Parse(args);
                        client.Character.Partner.rank = lv;
                        client.SendPetBasicInfo();
                    }
                    catch (Exception) { }
                }
        ...
        //ECOKEY 新增寵物相關調整
        private void ProcessPetReliability(MapClient client, string args)
        {
            if (client.Character.Partner == null)
            {
                client.SendSystemMessage("請叫出寵物");
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        byte lv = byte.Parse(args);
                        client.Character.Partner.reliability = lv;
                        client.SendPetBasicInfo();
                    }
                    catch (Exception) { }
                }
        ...
        //ECOKEY 爆擊機率
        //ECOKEY 爆擊機率
        private void ProcessBuffcri(MapClient client, string args)
        {
            int cri = 0;
            ActorPC sActor = client.Character;
            ...
            client.SendSystemMessage("素質爆擊率：" + ((ActorPC)sActor).Status.hit_critical.ToString());
            client.SendSystemMessage("技能爆擊率：" + ((ActorPC)sActor).Status.cri_skill.ToString());
            client.SendSystemMessage("裝備爆擊率：" + ((ActorPC)sActor).Status.cri_item.ToString());
            client.SendSystemMessage("卡片爆擊率：" + ((ActorPC)sActor).Status.hit_critical_iris.ToString());
            client.SendSystemMessage("--------------");
            client.SendSystemMessage("目前爆擊率：" + cri.ToString());
        }
        /*  private void ProcessBuffcri(MapClient client, string args)
          {
              int cri = 0;
        ...
        /* private void ProcessBuffcri(MapClient client, string args)
         {
             ...
             ActorPC sActor = client.Character;
             cri += ((ActorPC)sActor).Status.hit_critical + ((ActorPC)sActor).Status.cri_skill + ((ActorPC)sActor).Status.cri_item + ((ActorPC)sActor).Status.hit_critical_iris;
             criavd = ((ActorPC)sActor).Status.avoid_critical + ((ActorPC)sActor).Status.criavd_skill + ((ActorPC)sActor).Status.criavd_item + ((ActorPC)sActor).Status.avoid_critical_iris;
             if (sActor.Status.Additions.ContainsKey("CriUp"))//暴击标记
                 cri += (5 + sActor.Status.Cri_Up_Lv * 5);
             res = (float)(cri > criavd ? cri - criavd : 1);
             client.SendSystemMessage("目前爆擊率：" + res.ToString() + "%");
         }*/
        private void ProcessCheckFame(MapClient client, string args)
        {
            client.SendSystemMessage("目前的聲望為: " + client.Character.Fame);
        }
        ...
        //ECOKEY 外掛檢查
        private void ProcessplugInTest(MapClient client, string playername)
        {
            if (playername == "")
            {
                client.SendSystemMessage(LocalManager.Instance.Strings.ATCOMMAND_KICK_PARA);
        ...
        //ECOKEY 清除卡怪
        void ProcessKillAllMob2(MapClient client, string arg)
        {
            int count = 0;
            List<Actor> actors = client.Map.Actors.Values.ToList();
            foreach (Actor i in actors)
            ...
            client.SendSystemMessage(count.ToString() + " deadmobs killed");
        }
        /*void ProcessKillAllMob2(MapClient client, string arg)
        {
            List<Actor> actors = client.map.Actors.Values.ToList();
        ...
        //ECOKEY 0302卡寵修改測試
        private void ProcessClearAi(MapClient client, string args)
        {
            client.SendSystemMessage("AI數量" + SagaMap.Partner.AIThread.Instance.ActiveAI.ToString());
            SagaMap.Partner.AIThread.Instance.RemoveAIAll();
            client.SendSystemMessage("寵物AI已清除");
        }
        #endregion

        //ECOKEY 新增cp和ecoin查詢
        private void ProcessCp(MapClient client, string args)
        {
            client.SendSystemMessage("當前的CP為：" + client.Character.CP);
        }
        private void ProcessEcoin(MapClient client, string args)
        {
            client.SendSystemMessage("當前的Ecoin為：" + client.Character.ECoin);
        }
        private void ProcessOdwaranother(MapClient client, string args)//ECOKEY 攻防戰補象徵
        {
            ODWarManager.Instance.spawnSymbol_another(client.Map.ID, client);
        }

        #endregion
        public void ProcessKnightBuff(MapClient client, string args)//ECOKEY 騎士團BUFF測試
        {
            try
            {
                //uint name;
                ...
                try
                {
                    //name = uint.Parse(args.Split(' ')[0]);
                    name = args.Split(' ')[0];
                    foreach (Actor j in SagaMap.Manager.MapManager.Instance.GetMap(client.Character.MapID).Actors.Values)
                    {
                        if (j.type == ActorType.PC)
                        {
                            ActorPC pp = (ActorPC)j;
                            if (name == "n" && pp.Mode == PlayerMode.KNIGHT_NORTH)
                            {
                                SkillArg arg = new SkillArg();
                                arg.skill = SagaDB.Skill.SkillFactory.Instance.GetSkill(5537, 1);
                                SagaMap.Skill.SkillHandler.Instance.skillHandlers[5537].Proc(pp, pp, arg, 1);
                            }
                            if (name == "s" && pp.Mode == PlayerMode.KNIGHT_SOUTH)
                            {
                                SkillArg arg = new SkillArg();
                                arg.skill = SagaDB.Skill.SkillFactory.Instance.GetSkill(5537, 1);
                                SagaMap.Skill.SkillHandler.Instance.skillHandlers[5537].Proc(pp, pp, arg, 1);
                            }
                            if (name == "normal" && pp.Mode == PlayerMode.NORMAL)
                            {
                                SkillArg arg = new SkillArg();
                                arg.skill = SagaDB.Skill.SkillFactory.Instance.GetSkill(5537, 1);
                                SagaMap.Skill.SkillHandler.Instance.skillHandlers[5537].Proc(pp, pp, arg, 1);
