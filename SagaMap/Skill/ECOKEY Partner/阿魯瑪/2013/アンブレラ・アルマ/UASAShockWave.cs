...
{
    class UASAShockWave : Groove, ISkill
    {
        ...
        public void Proc(Actor sActor, Actor dActor, SkillArg args, byte level)
        {
            ...
            UASAActivatorA timer = new UASAActivatorA(actor, dActor, sActor, args, level);
    ...
    class UASAActivatorA : MultiRunTask
    {
        ...
        bool stop = false;
        public UASAActivatorA(ActorSkill actor, Actor dActor, Actor sActor, SkillArg args, byte level)
        {
            this.dueTime = 100;
            this.period = 1000;
        ...
        public override void CallBack()
        {
            ...
            if (count <= countMax)
            {
                ...
                if (DistanceA <= Diss)//If mob is out the range that FireBolt can cast, skip out.
                {
                    ...
                    int dmg = SkillHandler.Instance.CalcDamage(false, sActor, AimActor, Arg, SkillHandler.DefType.Def, Elements.Fire, 0, factor);
