...
{
    class BAShockWave : Groove, ISkill
    {
        ...
        public void Proc(Actor sActor, Actor dActor, SkillArg args, byte level)
        {
            ...
            BAActivatorA timer = new BAActivatorA(actor, dActor, sActor, args, level);
    ...
    class BAActivatorA : MultiRunTask
    {
        ...
        bool stop = false;
        public BAActivatorA(ActorSkill actor, Actor dActor, Actor sActor, SkillArg args, byte level)
        {
            this.dueTime = 100;
            this.period = 1000;
