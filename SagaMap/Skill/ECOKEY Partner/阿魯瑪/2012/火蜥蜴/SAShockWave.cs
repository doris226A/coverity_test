...
{
    class SAShockWave : Groove, ISkill
    {
        ...
        public void Proc(Actor sActor, Actor dActor, SkillArg args, byte level)
        {
            ...
            SAActivatorA timer = new SAActivatorA(actor, dActor, sActor, args, level);
    ...
    class SAActivatorA : MultiRunTask
    {
        ...
        bool stop = false;
        public SAActivatorA(ActorSkill actor, Actor dActor, Actor sActor, SkillArg args, byte level)
        {
            this.dueTime = 100;
            this.period = 1000;
