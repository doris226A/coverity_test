...
namespace SagaMap.Skill.SkillDefinations.Global
{
    ...
    /// ファイアストーム(烈焰风暴)
    /// </summary>
    public class SAElementStorm : ISkill
    {
        Elements element;
        public SAElementStorm(Elements e)
        {
            this.element = e;
        }
        ...
        public void Proc(SagaDB.Actor.Actor sActor, SagaDB.Actor.Actor dActor, SkillArg args, byte level)
        {
            ...
            List<Actor> actors = map.GetActorsArea(SagaLib.Global.PosX8to16(args.x, map.Width), SagaLib.Global.PosY8to16(args.y, map.Height), 100, null); //250
