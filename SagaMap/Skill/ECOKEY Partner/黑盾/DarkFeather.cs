...
namespace SagaMap.Skill.SkillDefinations.Druid
{
    ...
    /// ホーリーフェザー
    /// </summary>
    public class DarkFeather : ISkill
    {
        ...
        public void Proc(Actor sActor, Actor dActor, SkillArg args, byte level)
        {
            ...
            {
                ActorPC sPC = (ActorPC)((ActorPartner)sActor).Owner;
                if (sPC.Party != null)
                {
        ...
        {
            actor.Status.mp_recover_skill += 5;
            actor.Status.hp_recover_skill += 5;
            actor.Status.sp_recover_skill += 5;
