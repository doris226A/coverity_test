...
namespace SagaMap.Skill.SkillDefinations.Global
{
    ...
    /// 小丑
    /// </summary>
    public class Joker_None : ISkill
    {
        ...
        {
            //大傷
            actor.Status.max_atk1_skill -= (short)skill.Variable["Joker1_MAX_ATK1"];
            actor.Status.max_atk2_skill -= (short)skill.Variable["Joker1_MAX_ATK2"];
            actor.Status.max_atk3_skill -= (short)skill.Variable["Joker1_MAX_ATK3"];
            //小傷
            actor.Status.min_atk1_skill -= (short)skill.Variable["Joker1_MIN_ATK1"];
            actor.Status.min_atk2_skill -= (short)skill.Variable["Joker1_MIN_ATK2"];
            actor.Status.min_atk3_skill -= (short)skill.Variable["Joker1_MIN_ATK3"];

            //魔伤
            actor.Status.max_matk_skill -= (short)skill.Variable["Joker1_MAX_MATK"];
            actor.Status.min_matk_skill -= (short)skill.Variable["Joker1_MIN_MATK"];
