    ...
    public class HeavyMetal : ISkill
    {
            ...
            if (actor.skillsong != null)
            {
                ...
                foreach (Actor act in actors)
                {
                    if (act.type == ActorType.PC || act.type == ActorType.PARTNER)
                    {
                        ...
                        {
                            act.Status.Additions["HeavyMetal"].AdditionEnd();
                            act.Status.Additions.TryRemove("HeavyMetal", out _);
                        }
                    }
                }
            }
        ...
        private class Activator : MultiRunTask
        {
            ...
            void TimerEventHandler(Actor actor, DefaultBuff skill)
            {
                ...
                if (ranges > 200)
                {
                    actor.Status.Additions["HeavyMetal"].AdditionEnd();
                    actor.Status.Additions.TryRemove("HeavyMetal", out _);
                }
            }
        }
        #endregion
