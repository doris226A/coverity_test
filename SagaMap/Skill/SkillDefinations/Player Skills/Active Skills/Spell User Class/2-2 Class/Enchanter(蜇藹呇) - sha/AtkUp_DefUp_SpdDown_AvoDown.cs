...
namespace SagaMap.Skill.SkillDefinations.Enchanter
{
    ...
    public class AtkUp_DefUp_SpdDown_AvoDown : ISkill
    {
        ...
        {
            DefaultBuff skill = new DefaultBuff(args.skill, dActor, "AtkUp_DefUp_SpdDown_AvoDown", 180000);
        ...
        void StartEventHandler(Actor actor, DefaultBuff skill)
        {
            ...
            {
                def_add = (int)(actor.Status.def_bs * (0.21f + 0.01f * level));
                mdef_add = (int)(actor.Status.mdef_bs * (0.21f + 0.01f * level));
