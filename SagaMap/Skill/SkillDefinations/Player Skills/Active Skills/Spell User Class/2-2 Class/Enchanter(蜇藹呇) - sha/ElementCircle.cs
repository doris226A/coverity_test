...
namespace SagaMap.Skill.SkillDefinations.Enchanter
{
    ...
    public class ElementCircle : ISkill
    {
        ...
        public int TryCast(ActorPC pc, Actor dActor, SkillArg args)
        {
            ...
            if (map.Info.dark[args.x, args.y] >= 50)
            {
                return -17;
            }
            if (map.Info.holy[args.x, args.y] >= 50)
            {
                return -17;
            }
            if (map.Info.earth[args.x, args.y] >= 50)
            {
                return -17;
            }
            if (map.Info.fire[args.x, args.y] >= 50)
            {
                return -17;
            }
            if (map.Info.water[args.x, args.y] >= 50)
            {
                return -17;
            }
            if (map.Info.wind[args.x, args.y] >= 50)
            {
                return -17;
            }
            return 0;
