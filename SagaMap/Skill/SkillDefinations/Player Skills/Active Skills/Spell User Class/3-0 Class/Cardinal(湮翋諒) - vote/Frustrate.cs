    ...
    class Frustrate : ISkill
    {
        ...
        public void Proc(Actor sActor, Actor dActor, SkillArg args, byte level)
        {
            ...
            foreach (Actor i in actors)
            {
                ...
                {
                    if (i.Status.Additions.ContainsKey("StrVitAgiDownOne"))
                        SkillHandler.RemoveAddition(i, "StrVitAgiDownOne");
                    if (i.Status.Additions.ContainsKey("MagIntDexDownOne"))
                        SkillHandler.RemoveAddition(i, "MagIntDexDownOne");
