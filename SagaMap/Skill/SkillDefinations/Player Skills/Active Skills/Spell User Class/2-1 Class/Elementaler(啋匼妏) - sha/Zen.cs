...
namespace SagaMap.Skill.SkillDefinations.Elementaler
{
    ...
    public class Zen : ISkill
    {
        ...
        void StartEventHandler(Actor actor, DefaultBuff skill)
        {
            ...
            //酸性霧氣AcidMist
            actor.ZenOutLst.Add(3052);

            SagaMap.Network.Client.MapClient.FromActorPC((ActorPC)actor).SendSystemMessage("魔法極大化已進入狀態");
        }
        ...
        void EndEventHandler(Actor actor, DefaultBuff skill)
        {
            ...
            SagaMap.Network.Client.MapClient.FromActorPC((ActorPC)actor).SendSystemMessage("魔法極大化已解除狀態");
        }
        #endregion
    }
}
