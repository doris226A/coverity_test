                ...
                try
                {
                    if (count < countMax)
                    {
                        ...
                        foreach (Actor i in actors)
                        {
                            ...
                            {
                                if (SkillHandler.Instance.CanAdditionApply(caster, i, SkillHandler.DefaultAdditions.Stiff, 20 * this.skill.skill.Level))
                                {
                                    Additions.Global.Stiff skill = new SagaMap.Skill.Additions.Global.Stiff(this.skill.skill, i, (int)(750 + 250 * this.skill.skill.Level));
