                    ...
                    if (count < countMax)
                    {
                        ...
                        foreach (Actor i in actors)
                        {
                            if (SkillHandler.Instance.CheckValidAttackTarget(caster, i))
                            {
                                ...
                                {
                                    Additions.Global.Stun skill1 = new SagaMap.Skill.Additions.Global.Stun(thisargs.skill, i, 1000);
                                    SkillHandler.ApplyAddition(i, skill1);
                                }
                                else if (SkillHandler.Instance.CanAdditionApply(caster, i, SkillHandler.DefaultAdditions.鈍足, 30) && !SkillHandler.Instance.isBossMob(i))
                                {
                                    Additions.Global.MoveSpeedDown skill2 = new SagaMap.Skill.Additions.Global.MoveSpeedDown(thisargs.skill, i, 1000);
                                    SkillHandler.ApplyAddition(i, skill2);
                                }
                                else if (SkillHandler.Instance.CanAdditionApply(caster, i, SkillHandler.DefaultAdditions.Silence, 30) && !SkillHandler.Instance.isBossMob(i))
                                {
                                    Additions.Global.Silence skill3 = new SagaMap.Skill.Additions.Global.Silence(thisargs.skill, i, 1000);
                                    SkillHandler.ApplyAddition(i, skill3);
                                }
                                else if (SkillHandler.Instance.CanAdditionApply(caster, i, SkillHandler.DefaultAdditions.CannotMove, 30) && !SkillHandler.Instance.isBossMob(i))
                                {
                                    Additions.Global.CannotMove skill4 = new SagaMap.Skill.Additions.Global.CannotMove(thisargs.skill, i, 1000);
                                    SkillHandler.ApplyAddition(i, skill4);
                                }
                                else if (SkillHandler.Instance.CanAdditionApply(caster, i, SkillHandler.DefaultAdditions.Confuse, 30) && !SkillHandler.Instance.isBossMob(i))
                                {
                                    Additions.Global.Confuse skill5 = new SagaMap.Skill.Additions.Global.Confuse(thisargs.skill, i, 1000);
