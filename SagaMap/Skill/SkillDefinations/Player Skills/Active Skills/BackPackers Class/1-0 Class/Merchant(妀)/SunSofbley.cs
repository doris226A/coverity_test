...
namespace SagaMap.Skill.SkillDefinations.Merchant
{
    ...
    public class SunSofbley : ISkill
    {
        ...
        public void Proc(Actor sActor, Actor dActor, SkillArg args, byte level)
        {
            ...
            float[] factor = { 0f, 0.16f, 0.2f, 0.25f, 0.33f, 0.5f };
            ...
            //需有一個傷害直接指定數字給予的攻擊函數
            SkillHandler.Instance.PhysicalAttack(sActor, realAffected, args, SkillHandler.DefType.IgnoreAll, Elements.Neutral, Damge, 0, true);
        }
        #endregion
    }
}