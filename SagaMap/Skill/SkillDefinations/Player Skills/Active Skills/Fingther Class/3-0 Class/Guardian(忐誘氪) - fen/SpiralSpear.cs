    ...
    public class SpiralSpear : ISkill
    {
        ...
        public int TryCast(ActorPC pc, Actor dActor, SkillArg args)
        {
            ...
            if (dActor != null)
            {
                ...
                if (map != null)
                {
                    if (map.CheckActorSkillInRange(dActor.X, dActor.Y, 250))
                    {
                        return -17;
                    }
                    else
        ...
        private class Activator : MultiRunTask
        {
            ...
            public override void CallBack()
            {
                ...
                try
                {
                    ...
                    {
                        SkillHandler.Instance.SetNextComboSkill(caster, 2537);
                        SkillHandler.Instance.SetNextComboSkill(caster, 2512);
                        this.Deactivate();
                        //在指定地图删除技能体（技能效果结束）
