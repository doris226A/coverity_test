...
{
    public class BlastArrow : ISkill //Groove, ISkill
    {
        ...
        public void Proc(Actor sActor, Actor dActor, SkillArg args, byte level)
            ...
            Activator timer = new Activator(sActor, actor, args, path, Elements.Neutral);
            timer.Activate();
        }
...
namespace SagaMap.Skill.SkillDefinations.Striker
{
    ...
    public class BlastArrow : ISkill //Groove, ISkill 
    {
        ...
        public void Proc(Actor sActor, Actor dActor, SkillArg args, byte level)
        {
            ...
            {
                if (SkillHandler.Instance.CheckValidAttackTarget(sActor, dActor2))
                    dActor1.Add(dActor2);
            }
            SkillHandler.Instance.PhysicalAttack(sActor, dActor1, args, Elements.Neutral, ATKBonus);
        }
        #endregion
    }
}*/