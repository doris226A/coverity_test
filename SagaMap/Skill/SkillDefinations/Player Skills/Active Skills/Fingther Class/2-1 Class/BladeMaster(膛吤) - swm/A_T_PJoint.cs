    ...
    public class A_T_PJoint : ISkill
    {
        ...
        public class PJointBuff : DefaultBuff
        {
            ...
            void StartEvent(Actor actor, DefaultBuff skill)
            {
                ...
                //最大攻擊
                int max_atk1_add = (int)(sActor.Status.max_atk1  * factor);
                ...
                //最大攻擊
                int max_atk2_add = (int)(sActor.Status.max_atk2 * factor);
                ...
                //最大攻擊
                int max_atk3_add = (int)(sActor.Status.max_atk3 * factor);
                ...
                //最小攻擊
                int min_atk1_add = (int)(sActor.Status.min_atk1  * factor);
                ...
                //最小攻擊
                int min_atk2_add = (int)(sActor.Status.min_atk2 * factor);
                ...
                //最小攻擊
                int min_atk3_add = (int)(sActor.Status.min_atk3 * factor);
                ...
                MapClient.FromActorPC((ActorPC)actor).SendSystemMessage("攻擊援手已進入狀態");
            ...
            void EndEvent(Actor actor, DefaultBuff skill)
            {
                ...
                MapClient.FromActorPC((ActorPC)actor).SendSystemMessage("攻擊援手狀態已解除");
                Manager.MapManager.Instance.GetMap(actor.MapID).SendEventToAllActorsWhoCanSeeActor(Map.EVENT_TYPE.BUFF_CHANGE, null, actor, true);
            }
        }
