...
namespace SagaMap.Skill.SkillDefinations.Assassin
{
    ...
    public class PoisonReate3 : ISkill
    {
        ...
        void StartEventHandler(Actor actor, DefaultBuff skill)
        {
            ...
            //ER被動毒抗性
            if (pc.Skills2.ContainsKey(910)) rate -= pc.Skills2[910].Level * 3;
            if (pc.Skills2_1.ContainsKey(910)) rate -= pc.Skills2_1[910].Level * 3;
            if (pc.SkillsReserve.ContainsKey(910)) rate -= pc.SkillsReserve[910].Level * 3;
