...
using SagaDB.Actor;
using SagaLib;
//using SagaMap.Network.Client; //原先有
...
namespace SagaMap.Skill.SkillDefinations.Assassin
{
    ...
    public class EventSumNinJa : ISkill
    {
        ...
        public int TryCast(ActorPC pc, Actor dActor, SkillArg args) //(ActorPC sActor, Actor dActor, SkillArg args)
        {
            uint itemID = 10017150;//稻草娃娃
        ...
        public void Proc(Actor sActor, Actor dActor, SkillArg args, byte level)
        {
            ...
            ActorPC pc = (ActorPC)sActor; //原先前面有加//
            //ActorPC pc = MapClient.FromActorPC((ActorPC)sActor).Character; //原先有
            if (level == 1)
            {
