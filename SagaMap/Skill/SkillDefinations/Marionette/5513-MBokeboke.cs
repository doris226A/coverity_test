...
namespace SagaMap.Skill.SkillDefinations.Marionette
{
    ...
    public class MBokeboke : ISkill
    {
        ...
        void StartEventHandler(Actor actor, DefaultBuff skill)
        {
            ...
            //VIT
            int vit_skill = -(int)(actor.Status.vit_skill * 0.1f);
            if (skill.Variable.ContainsKey("MBokeboke_vit"))
                skill.Variable.Remove("MBokeboke_vit");
            skill.Variable.Add("MBokeboke_vit", vit_skill);
            actor.Status.vit_skill += (short)vit_skill;
