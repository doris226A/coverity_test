...
namespace SagaMap.Skill.SkillDefinations.Event
{
    ...
    public class MoveUp21 : ISkill
    {
        ...
        public void Proc(Actor sActor, Actor dActor, SkillArg args, byte level)
        {
            ...
            DefaultBuff skill = new DefaultBuff(args.skill, dActor, "MoveUp21", lifetime);
        ...
        void StartEventHandler(Actor actor, DefaultBuff skill)
        {
            ...
            if (actor.Status.Additions.ContainsKey("MoveUp2"))
            {
                actor.Status.Additions["MoveUp2"].AdditionEnd();
                actor.Status.Additions.TryRemove("MoveUp2", out _);
            }
            ...
            //移動速度
            int Speed_add = 100;
            if (skill.Variable.ContainsKey("MoveUp21_Speed"))
                skill.Variable.Remove("MoveUp21_Speed");
            skill.Variable.Add("MoveUp21_Speed", Speed_add);
        ...
        void EndEventHandler(Actor actor, DefaultBuff skill)
        {
            ...
            //移動速度
            actor.Status.speed_skill -= (ushort)skill.Variable["MoveUp21_Speed"];
