...
namespace SagaMap.Skill.SkillDefinations.Global
{
    ...
    public class ElementStorm : ISkill
    {
        ...
        public void Proc(SagaDB.Actor.Actor sActor, SagaDB.Actor.Actor dActor, SkillArg args, byte level)
        {
            ...
            {
                actors = map.GetActorsArea(dActor.X, dActor.Y, 250, null);
            }
            else
            {
                actors = map.GetActorsArea(SagaLib.Global.PosX8to16(args.x, map.Width), SagaLib.Global.PosY8to16(args.y, map.Height), 250, null);
            }
