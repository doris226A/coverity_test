...
namespace SagaMap.Skill.SkillDefinations.Global
{
    ...
    public class Trap : ISkill
    {
        ...
        public int TryCast(ActorPC sActor, Actor dActor, SkillArg args)
        {
            ...
            if (args.skill.ID == 2197)//ECOKEY 濕滑陷阱不用消耗品
                return 0;

            if (args.skill.ID == 3095 || args.skill.ID == 2284)
            {
                if (sActor.TInt["Trapnum"] >= args.skill.Level * 3)
                {
                    return -12;
                }
                itemID = 10022308;//地雷
            ...
            itemID = 10021901;//200耐久陷阱工具
            ActorPC pc = sActor as ActorPC;
            SagaDB.Item.Item item2 = sActor.Inventory.GetItem(itemID, Inventory.SearchType.ITEM_ID);
