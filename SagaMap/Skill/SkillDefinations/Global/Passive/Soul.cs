...
namespace SagaMap.Skill.SkillDefinations.Global
{
    ...
    public class Soul : ISkill
    {
        ...
        void SetupSkill(Actor actor, DefaultPassiveSkill skill)
        {
            ...
            {
                max_atk_bs_add1 = (int)(actor.Status.max_atk1 * (0.14));
                min_atk_bs_add1 = (int)(actor.Status.min_atk1 * (0.14));
                max_atk_bs_add2 = (int)(actor.Status.max_atk2 * (0.14));
                min_atk_bs_add2 = (int)(actor.Status.min_atk2 * (0.14));
                max_atk_bs_add3 = (int)(actor.Status.max_atk3 * (0.14));
                min_atk_bs_add3 = (int)(actor.Status.min_atk3 * (0.14));
            ...
            else if (actorPC.PossessionPosition == SagaLib.PossessionPosition.LEFT_HAND)
            {
                ...
                max_atk_bs_add1 = (int)(actor.Status.max_atk1 * (0.07));
                min_atk_bs_add1 = (int)(actor.Status.min_atk1 * (0.07));
                max_atk_bs_add2 = (int)(actor.Status.max_atk2 * (0.07));
                min_atk_bs_add2 = (int)(actor.Status.min_atk2 * (0.07));
                max_atk_bs_add3 = (int)(actor.Status.max_atk3 * (0.07));
                min_atk_bs_add3 = (int)(actor.Status.min_atk3 * (0.07));
            ...
            else if (actorPC.PossessionPosition == SagaLib.PossessionPosition.NECK)
            {
                ...
                max_atk_bs_add1 = (int)(actor.Status.max_atk1 * (0.08));
                min_atk_bs_add1 = (int)(actor.Status.min_atk1 * (0.08));
                max_atk_bs_add2 = (int)(actor.Status.max_atk2 * (0.08));
                min_atk_bs_add2 = (int)(actor.Status.min_atk2 * (0.08));
                max_atk_bs_add3 = (int)(actor.Status.max_atk3 * (0.08));
                min_atk_bs_add3 = (int)(actor.Status.min_atk3 * (0.08));
            ...
            else if (actorPC.PossessionPosition == SagaLib.PossessionPosition.CHEST)
            {
                ...
                max_atk_bs_add1 = (int)(actor.Status.max_atk1 * (0.05));
                min_atk_bs_add1 = (int)(actor.Status.min_atk1 * (0.05));
                max_atk_bs_add2 = (int)(actor.Status.max_atk2 * (0.05));
                min_atk_bs_add2 = (int)(actor.Status.min_atk2 * (0.05));
                max_atk_bs_add3 = (int)(actor.Status.max_atk3 * (0.05));
                min_atk_bs_add3 = (int)(actor.Status.min_atk3 * (0.05));
            ...
            skill.Variable.Add("Soul_max_atk_bs_add", max_atk_bs_add1);
            actor.Status.max_atk1_possession = (short)max_atk_bs_add1;

            if (skill.Variable.ContainsKey("Soul_max_atk_bs_add"))
                skill.Variable.Remove("Soul_max_atk_bs_add");
            skill.Variable.Add("Soul_max_atk_bs_add", max_atk_bs_add2);
            actor.Status.max_atk2_possession = (short)max_atk_bs_add2;

            if (skill.Variable.ContainsKey("Soul_max_atk_bs_add"))
                skill.Variable.Remove("Soul_max_atk_bs_add");
            skill.Variable.Add("Soul_max_atk_bs_add", max_atk_bs_add3);
            actor.Status.max_atk3_possession = (short)max_atk_bs_add3;
            //小傷
            if (skill.Variable.ContainsKey("Soul_min_atk_bs_add"))
                skill.Variable.Remove("Soul_min_atk_bs_add");
            skill.Variable.Add("Soul_min_atk_bs_add", min_atk_bs_add1);
            actor.Status.min_atk1_possession = (short)min_atk_bs_add1;

            if (skill.Variable.ContainsKey("Soul_min_atk_bs_add"))
                skill.Variable.Remove("Soul_min_atk_bs_add");
            skill.Variable.Add("Soul_min_atk_bs_add", min_atk_bs_add2);
            actor.Status.min_atk2_possession = (short)min_atk_bs_add2;

            if (skill.Variable.ContainsKey("Soul_min_atk_bs_add"))
                skill.Variable.Remove("Soul_min_atk_bs_add");
            skill.Variable.Add("Soul_min_atk_bs_add", min_atk_bs_add3);
            actor.Status.min_atk3_possession = (short)min_atk_bs_add3;
        }
        #endregion
    }
}
