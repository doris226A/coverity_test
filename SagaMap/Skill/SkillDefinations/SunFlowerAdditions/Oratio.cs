...
namespace SagaMap.Skill.SkillDefinations.SunFlowerAdditions
{
    ...
    public class Oratio : ISkill
    {
        ...
        void StartEventHandler(Actor actor, DefaultBuff skill)
        {
            ...
            {
                MapClient.FromActorPC((ActorPC)actor).SendSystemMessage("六屬性抗性上升");
            }
            actor.Buff.BodyNatureElementUp = true;
            actor.Buff.FireShield = true;
            actor.Buff.WaterShield = true;
            actor.Buff.WindShield = true;
            actor.Buff.EarthShield = true;
            actor.Buff.HolyShield = true;
        ...
        void EndEventHandler(Actor actor, DefaultBuff skill)
        {
            if (actor.type == ActorType.PC)
            {
                MapClient.FromActorPC((ActorPC)actor).SendSystemMessage("六屬性抗性恢復正常");
            }
            actor.Buff.BodyNatureElementUp = false;
            actor.Buff.FireShield = false;
            actor.Buff.WaterShield = false;
            actor.Buff.WindShield = false;
            actor.Buff.EarthShield = false;
            actor.Buff.HolyShield = false;
