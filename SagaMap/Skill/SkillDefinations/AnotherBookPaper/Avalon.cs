...
namespace SagaMap.Skill.SkillDefinations.AnotherBookPaper
{
    ...
    public class Avalon : ISkill
    {
        ...
        public int TryCast(ActorPC pc, Actor dActor, SkillArg args)
        {
            ...
            if (pc.Status.Additions.ContainsKey("Avalon"))
                return -30;
        ...
        {
            int[] lifetime = { 0, 20000, 20000, 20000, 20000, 20000, 20000, 20000, 20000, 20000, 25000, 25000, 25000, 30000, 30000, 30000 };
            DefaultBuff skill = new DefaultBuff(args.skill, sActor, "Avalon", lifetime[level]);
        ...
        private class Activator : MultiRunTask
        {
            ...
            public Activator(Actor caster, ActorSkill actor, SkillArg args, byte level)
            {
                ...
                this.lifetime = new int[] { 0, 20000, 20000, 20000, 20000, 20000, 20000, 20000, 20000, 20000, 25000, 25000, 25000, 30000, 30000, 30000 }[level];
                this.countMax = lifetime / period;
            }
