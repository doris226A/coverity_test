...
namespace SagaMap.Skill.SkillDefinations.AnotherBookPaper
{
    ...
    class Intermezzo : ISkill
    {
        ...
        public void Proc(SagaDB.Actor.Actor sActor, SagaDB.Actor.Actor dActor, SkillArg args, byte level)
        {
            ...
            float factor = factor = new float[] { 0, 45.0f, 48.0f, 51.0f, 60.0f, 63.0f, 67.0f, 73.0f, 76.0f, 79.0f, 85.0f, 88.0f, 91.0f, 94.0f, 98.0f, 105.0f }[level];
