...
namespace SagaMap.Skill.SkillDefinations.AnotherBookPaper
{
    ...
    /// ブラッディストーム
    /// </summary>
    public class BloodyStorm : ISkill
    {
        ...
        public void Proc(Actor sActor, Actor dActor, SkillArg args, byte level)
        {
            ...
            timer.Activate();
            args.autoCast.Add(SkillHandler.Instance.CreateAutoCastInfo(2575, args.skill.Level, 6000));
        }
        ...
        private class Activator : MultiRunTask
        {
            ...
            public Activator(Actor caster, ActorSkill actor, SkillArg args, byte level)
            {
                ...
                this.countMax = new int[] { 0, 3, 3, 3, 4, 4, 4, 5, 5, 5, 6, 6, 6, 7, 7, 8 }[level];
                int lifetime = 2500;
