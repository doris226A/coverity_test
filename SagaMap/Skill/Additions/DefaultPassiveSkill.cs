...
namespace SagaMap.Skill.Additions.Global
{
    public class DefaultPassiveSkill : Addition
    {
        ...
        /// <summary>
        /// Constructor for Addition: Such as Short Sword Mastery
        /// </summary>
        /// <param name="skill">Skill Object</param>
        /// <param name="actor">Actor, which this addition get attached to</param>
        /// <param name="name">Addition Name</param>
        /// <param name="ifActivate">Activate Immediately</param>
        public DefaultPassiveSkill(SagaDB.Skill.Skill skill, Actor actor, string name, bool ifActivate)
        {
            ...
            this.EcoKeySkillType = AdditionType.PassiveSkill;//ECOKEY 技能類別新增
        }
