    ...
    public class SwordCancel : ISkill
    {
        ...
        bool CheckPossible(Actor sActor)
        {
            if (sActor.type == ActorType.PC)
            {
                ...
                {
                    if (equips[SagaDB.Item.EnumEquipSlot.RIGHT_HAND].BaseData.itemType == SagaDB.Item.ItemType.PARTS_SLASH ||
                        equips[SagaDB.Item.EnumEquipSlot.RIGHT_HAND].BaseData.itemType == SagaDB.Item.ItemType.SETPARTS_SLASH)
                        return true;
                    else
                        return false;
                }
        ...
        void EndEventHandler(Actor actor, DefaultBuff skill)
        {
            ...
            actor.Buff.MasterOfSword = false;
            Manager.MapManager.Instance.GetMap(actor.MapID).SendEventToAllActorsWhoCanSeeActor(Map.EVENT_TYPE.BUFF_CHANGE, null, actor, true);
        }
