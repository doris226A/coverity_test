    ...
    public class AxeCancel : ISkill
    {
        ...
        bool CheckPossible(Actor sActor)
        {
            if (sActor.type == ActorType.PC)
            {
                ...
                {
                    if (equips[SagaDB.Item.EnumEquipSlot.RIGHT_HAND].BaseData.itemType == SagaDB.Item.ItemType.PARTS_BLOW ||
                        equips[SagaDB.Item.EnumEquipSlot.RIGHT_HAND].BaseData.itemType == SagaDB.Item.ItemType.SETPARTS_BLOW)
                        return true;
                    else
                        return false;
                }
