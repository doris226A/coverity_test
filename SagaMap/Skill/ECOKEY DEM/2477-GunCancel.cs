    ...
    public class GunCancel : ISkill
    {
        ...
        bool CheckPossible(Actor sActor)
        {
            if (sActor.type == ActorType.PC)
            {
                ...
                {
                    if (equips[SagaDB.Item.EnumEquipSlot.RIGHT_HAND].BaseData.itemType == SagaDB.Item.ItemType.PARTS_LONGRANGE ||
                        equips[SagaDB.Item.EnumEquipSlot.RIGHT_HAND].BaseData.itemType == SagaDB.Item.ItemType.SETPARTS_LONGRANGE)
                        return true;
                    else
                        return false;
                }
