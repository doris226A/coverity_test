...
namespace SagaMap.Skill
{
    public partial class SkillHandler : Singleton<SkillHandler>
    {
        ...
        public void Init()
        {
            ...
            //ECOKEY
            skillHandlers.Add(27000, new SagaMap.Skill.SkillDefinations.ECOKEY.Logging());
            ...
            #region Another Book Paper Skill
            skillHandlers.Add(2571, new Skill.SkillDefinations.AnotherBookPaper.AbilityRelease());
            skillHandlers.Add(2588, new Skill.SkillDefinations.AnotherBookPaper.Concerttate());
            skillHandlers.Add(2589, new Skill.SkillDefinations.AnotherBookPaper.ConcerttateSEQ());
            skillHandlers.Add(2591, new Skill.SkillDefinations.AnotherBookPaper.Intermezzo());
            skillHandlers.Add(2576, new Skill.SkillDefinations.AnotherBookPaper.CatThatSwing());
            skillHandlers.Add(2577, new Skill.SkillDefinations.AnotherBookPaper.CatClawHunting());//未完成
            skillHandlers.Add(2599, new Skill.SkillDefinations.AnotherBookPaper.WolfeOfChain());
            skillHandlers.Add(2601, new Skill.SkillDefinations.AnotherBookPaper.WolfOfPain());
            skillHandlers.Add(2602, new Skill.SkillDefinations.AnotherBookPaper.WolfOfPainSEQ());
            skillHandlers.Add(2612, new Skill.SkillDefinations.AnotherBookPaper.Avalon());
            skillHandlers.Add(2573, new Skill.SkillDefinations.AnotherBookPaper.VanSpeania());
            skillHandlers.Add(2574, new Skill.SkillDefinations.AnotherBookPaper.BloodyStorm());
            skillHandlers.Add(2575, new Skill.SkillDefinations.AnotherBookPaper.BloodyStormSEQ());
            skillHandlers.Add(2603, new Skill.SkillDefinations.AnotherBookPaper.ALaughingSmile());
            skillHandlers.Add(2586, new Skill.SkillDefinations.AnotherBookPaper.LoveMyFriends());
            skillHandlers.Add(2587, new Skill.SkillDefinations.AnotherBookPaper.SunSanSamba());
            skillHandlers.Add(2592, new Skill.SkillDefinations.AnotherBookPaper.AzothBorder());
            skillHandlers.Add(2593, new Skill.SkillDefinations.AnotherBookPaper.AzothBorder1());
            skillHandlers.Add(2594, new Skill.SkillDefinations.AnotherBookPaper.AzothBorder2());
            skillHandlers.Add(2595, new Skill.SkillDefinations.AnotherBookPaper.AzothBorder3());
            skillHandlers.Add(2596, new Skill.SkillDefinations.AnotherBookPaper.AzothBorder4());
            skillHandlers.Add(2597, new Skill.SkillDefinations.AnotherBookPaper.AzothBorder5());
            //SunSanSamba
            //Bloody storm
            //Avalon
            //ウルフオブチェイン
            ...
            skillHandlers.Add(2492, new SkillDefinations.Royaldealer.DamagePossession());//ECOKEY LV20 精神標記
            //noLv20
            ...
            skillHandlers.Add(995, new SkillDefinations.Royaldealer.BagMaster());//ECOKEY LV45 鞄の達人
            ...
            skillHandlers.Add(2560, new SkillDefinations.Global.Joker_None());//ECOKEY 小丑J50空手
            skillHandlers.Add(2561, new SkillDefinations.Global.Joker_Normal());//ECOKEY 小丑J50一般武器 鞭子
            skillHandlers.Add(2562, new SkillDefinations.Global.Joker_Long());//ECOKEY 小丑J50遠距離
            skillHandlers.Add(2563, new SkillDefinations.Global.Joker_TwoHead());//ECOKEY 小丑J50雙手系列
            skillHandlers.Add(2564, new SkillDefinations.Global.Joker_Magic());//ECOKEY 小丑J50法系
            skillHandlers.Add(2566, new SkillDefinations.Global.Joker_None());//ECOKEY 小丑J50空手-原
            skillHandlers.Add(2495, new SkillDefinations.Global.DamageCharge());//ECOKEY 傷害蔓延
            skillHandlers.Add(2496, new SkillDefinations.Global.DamageCharge_Boom());//ECOKEY 傷害蔓延-爆炸
            skillHandlers.Add(2493, new SkillDefinations.Global.JokerProvocation());//ECOKEY 小丑挑釁
            #endregion
            ...
            skillHandlers.Add(988, new SkillDefinations.Stryder.Strider());//ECOKEY LV10被動，風行者
            //lv10被动不知作用
            ...
            skillHandlers.Add(2506, new SkillDefinations.Maestro.RobotASPDUp());//12月1日实装，lv25
            skillHandlers.Add(3401, new SkillDefinations.Maestro.WeaponAtkUp());//12月1日实装，lv30
            skillHandlers.Add(2509, new SkillDefinations.Maestro.Roquefort());//ECOKEY LV35土石流
            //缺少35、40
            ...
            skillHandlers.Add(2499, new SkillDefinations.Guardian.AegisShield());//ECOKEY 宙斯盾，lv23
            ...
            skillHandlers.Add(4030, new SkillDefinations.SoulTaker.PossessorSeal());//ECOKEY 憑依者封印，lv25
            ...
            skillHandlers.Add(3360, new SkillDefinations.Harvest.PAYLCommunion());//12月2日实装，lv6//ECOKEY 重量增加
            ...
            skillHandlers.Add(9257, new SkillDefinations.FGarden.FGRope());
            #endregion

            #region Mob
            //skillHandlers.Add(6640, new SkillDefinations.Monster.ChargeArrow());
            skillHandlers.Add(7843, new SkillDefinations.Global.ElementShield(Elements.Fire, true));
            skillHandlers.Add(7844, new SkillDefinations.Global.ElementShield(Elements.Wind, true));
            skillHandlers.Add(7845, new SkillDefinations.Global.ElementShield(Elements.Water, true));
            skillHandlers.Add(7846, new SkillDefinations.Global.ElementShield(Elements.Earth, true));
            skillHandlers.Add(7847, new SkillDefinations.Global.ElementShield(Elements.Holy, true));
            skillHandlers.Add(7848, new SkillDefinations.Global.ElementShield(Elements.Dark, true));
            ...
            skillHandlers.Add(7595, new SkillDefinations.Global.SumSlaveMob(10310001));//艾卡納J牌
            ...
            skillHandlers.Add(27037, new SkillDefinations.Monster.A7627());
            ...
            skillHandlers.Add(7727, new SkillDefinations.Global.SumSlaveMob(10211400));//夜叉蜘蛛
              // skillHandlers.Add(7732, new SkillDefinations.Monster.MobCancelChgstateAll()); 驅散 
            ...
            skillHandlers.Add(7740, new SkillDefinations.Monster.MobComboConAtk());//武神更改
            ...
            skillHandlers.Add(7743, new SkillDefinations.Monster.MobComboConAtk());//武神更改
            ...
            skillHandlers.Add(6605, new SkillDefinations.Monster.MobAppeal());//召喚系 傭兵 - 武士的覺悟
            skillHandlers.Add(7765, new SkillDefinations.Monster.MobFurious());//召喚系 傭兵 - 憤怒
            skillHandlers.Add(6602, new SkillDefinations.Monster.MobNGMuSoU());//召喚系 巴迪安 - 滅！
            skillHandlers.Add(6603, new SkillDefinations.Monster.MobAreaHeal());//召喚系 行會商人 - 生命秘藥
            skillHandlers.Add(6604, new SkillDefinations.Monster.MobMAtkAtkup());//召喚系 行會商人 - 全力支援
            skillHandlers.Add(7791, new SkillDefinations.Monster.MobPushStun());//召喚系 行會商人 - 有毒爆炸
            //skillHandlers.Add(7790, new SkillDefinations.Monster.OneStPLL());//一周年怪專用，魔改//先關閉
            ...
            skillHandlers.Add(7803, new SkillDefinations.Monster.IcicleTenor());
            skillHandlers.Add(7804, new SkillDefinations.Monster.AquaWave());//怒海惊澜
            ...
            skillHandlers.Add(7822, new SkillDefinations.Monster.IsSeN());
            ...
            skillHandlers.Add(7855, new SkillDefinations.Monster.MobDeflationaryWeapon());//怪物用使玩家属性攻击无效化
            ...
            skillHandlers.Add(7871, new SkillDefinations.Global.SumSlaveMob(10271005, 6));//ガーディアンフェザー（黑羽，50WHP）
            ...
            skillHandlers.Add(7882, new SkillDefinations.Global.SumSlaveMob(10340302));//巨人
            ...
            skillHandlers.Add(7900, new SkillDefinations.Global.SumSlaveMob(14280001, 3));//玛尔斯
            skillHandlers.Add(7901, new SkillDefinations.Global.SumSlaveMob(10221500));//粉色鬼火
            skillHandlers.Add(7902, new SkillDefinations.Global.SumSlaveMob(10130406));//海蛇（白）
            ...
            skillHandlers.Add(7916, new SkillDefinations.Monster.BoomAll());//ECOKEY 自爆-無差別攻擊
            skillHandlers.Add(7920, new SkillDefinations.Global.SumSlaveMob(15650005, 4));//アツゥイコロエカシ(红跳跳)
            skillHandlers.Add(7928, new SkillDefinations.Monster.RayStorm());//レイビングストーム
            skillHandlers.Add(7929, new SkillDefinations.Monster.InvariantFrame());//インバリデイトフレーム
            skillHandlers.Add(7931, new SkillDefinations.Monster.MaplePlume());//メイルシュトローム
            skillHandlers.Add(7932, new SkillDefinations.Monster.AbsolutJolt());//メイルシュトローム
            skillHandlers.Add(7936, new SkillDefinations.Monster.Abelration());//アブリテレイション
            skillHandlers.Add(7938, new SkillDefinations.Global.SumSlaveMob(10275002, 4));//グロリアスフェザー
            skillHandlers.Add(7939, new SkillDefinations.Global.SumSlaveMob(15990001, 4));//アイスアルムシュプリッター
            skillHandlers.Add(7954, new SkillDefinations.Global.SumSlaveMob(15300001, 4));//古代の魔道書
            skillHandlers.Add(7955, new SkillDefinations.Global.SumSlaveMob(16000900, 6));//カゲの従者
            skillHandlers.Add(7956, new SkillDefinations.Monster.DonnotRunAway());//こら……逃げるなよ
            skillHandlers.Add(7957, new SkillDefinations.Monster.ZillionBladeBoss());//こら……逃げるなよ-无尽斩
            skillHandlers.Add(7959, new SkillDefinations.Monster.LightOfTheDarknessBoss());//……足が止まってるよ
            ...
            skillHandlers.Add(8439, new SkillDefinations.Monster.MobShockWave());
           ...
           // skillHandlers.Add(9106, new SkillDefinations.Cabalist.EventSelfDarkStorm(true));
            ...
            skillHandlers.Add(1504, new SkillDefinations.Event.HarmReduce());//魔防術
            //EyeballRaiders
            skillHandlers.Add(1505, new SkillDefinations.Global.EyeballUsual());
            skillHandlers.Add(1506, new SkillDefinations.Global.EyeballRaiders());
            skillHandlers.Add(1507, new SkillDefinations.Global.EyeballKeeper());

            skillHandlers.Add(6653, new SkillDefinations.Global.GlitteringPupilIce());
            skillHandlers.Add(6654, new SkillDefinations.Global.GlitteringPupilStone());
            skillHandlers.Add(6655, new SkillDefinations.Global.GlitteringPupilStun());
            ...
            skillHandlers.Add(5511, new SkillDefinations.Event.Bubble());//新增人魚活動木偶技能

            skillHandlers.Add(6415, new SkillDefinations.Event.MoveUp2());
            skillHandlers.Add(6452, new SkillDefinations.Event.MoveUp21());
            ...
            skillHandlers.Add(200, new SkillDefinations.Swordman.SwordHitUP());
            skillHandlers.Add(2000, new SkillDefinations.Swordman.HitMeleeUp());
            skillHandlers.Add(2110, new SkillDefinations.Swordman.Blow());
            skillHandlers.Add(107, new SkillDefinations.Swordman.SwordMastery());
            ...
            #region BladeMaster
            skillHandlers.Add(904, new SkillDefinations.BladeMaster.FoodFighter());
            skillHandlers.Add(978, new SkillDefinations.BladeMaster.AtkUpByPt());
            skillHandlers.Add(2124, new SkillDefinations.BladeMaster.Sinkuha());
            skillHandlers.Add(119, new SkillDefinations.BladeMaster.TwoHandMastery());
            ...
            //ECOKEY 狂戰士操控
            skillHandlers.Add(701, new SkillDefinations.BladeMaster.P_BERSERK_Control());
            ...
            skillHandlers.Add(206, new SkillDefinations.Scout.ShortSwordHitUP());
            ...
            skillHandlers.Add(3282, new SkillDefinations.Scout.Hiding2());
            ...
            //ECOKEY 特工技能2408~2412編號錯亂，直接整段覆蓋即可
            #region Command
            ...
            skillHandlers.Add(2410, new SkillDefinations.Command.RushBom());
            skillHandlers.Add(2411, new SkillDefinations.Command.RushBomSeq());
            skillHandlers.Add(2412, new SkillDefinations.Command.RushBomSeq2());
            skillHandlers.Add(2409, new SkillDefinations.Command.SumCommand());
            skillHandlers.Add(2360, new SkillDefinations.Command.CyclOne());
            skillHandlers.Add(128, new SkillDefinations.Command.TwoHandGunMastery());
            ...
            skillHandlers.Add(2415, new SkillDefinations.Command.WildDance2a());
            skillHandlers.Add(2416, new SkillDefinations.Command.WildDance2b());
            skillHandlers.Add(2417, new SkillDefinations.Command.WildDance2c());
            #endregion
          ...
          //  skillHandlers.Add(698, new SkillDefinations.Wizard.Heating1());
           ...
           // skillHandlers.Add(3011, new SkillDefinations.Shaman.FireWall());
            ...
            //ECOKEY 元素四重奏
            skillHandlers.Add(3302, new SkillDefinations.Elementaler.CycloneGroove());
            skillHandlers.Add(3303, new SkillDefinations.Elementaler.CycloneGrooveFire());
            skillHandlers.Add(3304, new SkillDefinations.Elementaler.CycloneGrooveWind());
            skillHandlers.Add(3305, new SkillDefinations.Elementaler.CycloneGrooveWater());
            ...
            skillHandlers.Add(3316, new SkillDefinations.Enchanter.BestowTheElement());
            ...
            skillHandlers.Add(113, new SkillDefinations.Archer.BowMastery());
            ...
            skillHandlers.Add(109, new SkillDefinations.Fencer.SpearMastery());
            ...
            skillHandlers.Add(202, new SkillDefinations.Fencer.SpearHitUP());
            #endregion

            #region Knight
            skillHandlers.Add(2228, new SkillDefinations.Knight.HolyBlade());
            skillHandlers.Add(123, new SkillDefinations.Knight.RapierMastery());
            skillHandlers.Add(3170, new SkillDefinations.Knight.Healing());
            skillHandlers.Add(120, new SkillDefinations.Knight.TwoSpearMastery());
            ...
            skillHandlers.Add(111, new SkillDefinations.Tatarabe.MaceMastery());
            skillHandlers.Add(208, new SkillDefinations.Tatarabe.MaceHitUP());
            ...
            skillHandlers.Add(121, new SkillDefinations.Blacksmith.TwoMaceMastery());
            ...
            skillHandlers.Add(930, new SkillDefinations.Global.ElementAddUp(Elements.Fire, "FireAddUp"));
            ...
            skillHandlers.Add(108, new SkillDefinations.Farmasist.AxeMastery());
            skillHandlers.Add(204, new SkillDefinations.Farmasist.AxeHitUP());
            #endregion

            #region Alchemist
            skillHandlers.Add(7749, new SkillDefinations.Alchemist.PetPlantPoison(true));
            skillHandlers.Add(122, new SkillDefinations.Alchemist.TwoAxeMastery());
            ...
            skillHandlers.Add(4028, new SkillDefinations.Alchemist.Super_A_T_PJoint());//强力援手
            skillHandlers.Add(2254, new SkillDefinations.Alchemist.GuidePlant());//ECOKEY 植物感應
            #endregion

            #region Marionest
            skillHandlers.Add(2024, new SkillDefinations.Global.Synthese());
            ...
            skillHandlers.Add(3338, new SkillDefinations.Marionest.SumMario(26010000, 3339));//召喚風鬼
            ...
            skillHandlers.Add(3290, new SkillDefinations.Necromancer.DarkFlare());
            #endregion
            ...
            //ECOKEY J50最終攻擊
            skillHandlers.Add(2408, new SkillDefinations.DarkStalker.DarknessOfNight3());
            ...
            skillHandlers.Add(2266, new SkillDefinations.Striker.ABlastArrow());
            ...
            skillHandlers.Add(2106, new SkillDefinations.TreasureHunter.UnlockContainer());//ECOKEY 破解密碼(打開集裝箱)
            ...
            //ECOKEY 補上商人/傭兵召喚/掉寶率提升
            skillHandlers.Add(2393, new SkillDefinations.Trader.SumDealer());
            skillHandlers.Add(3348, new SkillDefinations.Trader.SumMercenary());
            skillHandlers.Add(3349, new SkillDefinations.Trader.TreasureUp());
            #endregion
            ...
            //ECOKEY 欺詐骰子ID修正
            skillHandlers.Add(2438, new SkillDefinations.Gambler.TrickDice());//ECOKEY 欺詐骰子ID修正
            ...
            skillHandlers.Add(2436, new SkillDefinations.Gambler.SumArcanaCard4());//ECOKEY 艾卡女王ID修正
            skillHandlers.Add(2437, new SkillDefinations.Gambler.SumArcanaCard5());//ECOKEY 艾卡納王ID修正
            ...
            skillHandlers.Add(2450, new SkillDefinations.Gardener.Gathering());//ECOKEY 規模種植
            ...
            skillHandlers.Add(2448, new SkillDefinations.Global.Synthese());//ECOKEY 品種改良
            ...
            skillHandlers.Add(2454, new SkillDefinations.Gardener.FurnitureDecomposition());//ECOKEY 家具分解
            #endregion
            ...
            #region 蔬菜棒
            skillHandlers.Add(6053, new SkillDefinations.Event.AtkUpSticks());
            skillHandlers.Add(6056, new SkillDefinations.Event.MAtkUpSticks());
            skillHandlers.Add(6054, new SkillDefinations.Event.DefUpSticks());
            skillHandlers.Add(6057, new SkillDefinations.Event.MDefUpSticks());
            skillHandlers.Add(6055, new SkillDefinations.Event.CriUpSticks());
            skillHandlers.Add(6058, new SkillDefinations.Event.HealUpSticks());

            skillHandlers.Add(9119, new SkillDefinations.Event.PetPassing());//寵物守護藥劑
            #endregion
           ...
           // skillHandlers.Add(6760, new SkillDefinations.Global.TheRevelationOfKuo());//玉藻专用技能
            ...
            #region DEM
            skillHandlers.Add(2565, new SkillDefinations.Global.OverClock());
            skillHandlers.Add(3423, new SkillDefinations.Global.FireArt());
            skillHandlers.Add(3438, new SkillDefinations.Global.CrossingEdge());
            skillHandlers.Add(3440, new SkillDefinations.Global.RapidStrike());
            skillHandlers.Add(3439, new SkillDefinations.Global.SonicBreaker());
            skillHandlers.Add(3442, new SkillDefinations.Global.CoupDura());
            skillHandlers.Add(3444, new SkillDefinations.Global.InsanityVotex());
            skillHandlers.Add(3443, new SkillDefinations.Global.LegacySpell());
            //ECOKEY DEM四種達人
            skillHandlers.Add(2474, new SkillDefinations.Global.AxeCancel());
            skillHandlers.Add(2475, new SkillDefinations.Global.SwordCancel());
            skillHandlers.Add(2476, new SkillDefinations.Global.SpearCancel());
            skillHandlers.Add(2477, new SkillDefinations.Global.GunCancel());
            #endregion

            //ECOKEY
            #region Ghost Dance Tsuji Muzan //無慘
            skillHandlers.Add(8048, new SkillDefinations.Necromancer.GDTMDarkFlare());
            skillHandlers.Add(8049, new SkillDefinations.ForceMaster.GDTMDecreaseShield());//11月26日实装
            skillHandlers.Add(8050, new SkillDefinations.SoulTaker.GDTMMegaDarkBlaze());
            skillHandlers.Add(8051, new SkillDefinations.BladeMaster.GDTMaHundredSpriteCry());
            skillHandlers.Add(8052, new SkillDefinations.Sorcerer.GDTMDevineBarrier());
            skillHandlers.Add(8053, new SkillDefinations.Swordman.GDTMSwordCancel());
            #endregion

            #region Kamado Nezuko //彌豆子
            skillHandlers.Add(8068, new SkillDefinations.Swordman.KNTOverWork());
            skillHandlers.Add(8069, new SkillDefinations.Swordman.KNProvocation());
            skillHandlers.Add(8070, new SkillDefinations.Swordman.KNSacrifice());
            skillHandlers.Add(8071, new SkillDefinations.Swordman.KNFurious());
            skillHandlers.Add(8072, new SkillDefinations.Stryder.KNStrapFlurry());
            skillHandlers.Add(8073, new SkillDefinations.Necromancer.KNHAbsorbHpWeapon());
            #endregion

            #region Guardian's Shield 守護者之盾
            skillHandlers.Add(1502, new SkillDefinations.Swordman.GSParry());
            #endregion

            #region Attack Skills  //攻擊技能(物理攻擊)
            skillHandlers.Add(6811, new SkillDefinations.Merchant.ASMagrow());
            skillHandlers.Add(6807, new SkillDefinations.Explorer.ASBlinding());
            skillHandlers.Add(6315, new SkillDefinations.BladeMaster.ASPetWarCry());
            skillHandlers.Add(6409, new SkillDefinations.Swordman.ASProvocation());
            skillHandlers.Add(6620, new SkillDefinations.Blacksmith.ASEearthCrash());
            skillHandlers.Add(6625, new SkillDefinations.BountyHunter.ASIsSeN());
            skillHandlers.Add(6639, new SkillDefinations.Command.ASWildDance());
            skillHandlers.Add(6810, new SkillDefinations.Knight.ASHitRow());
            skillHandlers.Add(6658, new SkillDefinations.Alchemist.ASDustExplosion());
            skillHandlers.Add(6642, new SkillDefinations.Alchemist.ASPhalanx());
            #endregion

            #region Magic Attack  //攻擊技能(魔法攻擊)
            skillHandlers.Add(6815, new SkillDefinations.Merchant.MAPowerDownATK());
            skillHandlers.Add(6818, new SkillDefinations.Shaman.MAIceArrow());
            skillHandlers.Add(6061, new SkillDefinations.Global.ElementStorm(Elements.Water));
            skillHandlers.Add(6814, new SkillDefinations.Shaman.MAColdBlast());
            skillHandlers.Add(6812, new SkillDefinations.Shaman.MAFireBlast());
            skillHandlers.Add(6813, new SkillDefinations.Shaman.MALightningBlast());
            skillHandlers.Add(6802, new SkillDefinations.Shaman.MALandKlug());
            skillHandlers.Add(6506, new SkillDefinations.Warlock.MABlackWidow());
            skillHandlers.Add(6634, new SkillDefinations.Bard.MALoudSong());
            skillHandlers.Add(6434, new SkillDefinations.Enchanter.MAGravityFall());
            #endregion

            #region Auxiliary Skills //輔助技能
            skillHandlers.Add(6417, new SkillDefinations.Scout.ASAvoidMeleeUp());
            //skillHandlers.Add(6412, new SkillDefinations.Swordman.DFATKUp());
            skillHandlers.Add(6419, new SkillDefinations.Swordman.SACounter());
            skillHandlers.Add(6440, new SkillDefinations.Vates.CureStatus("Poison"));
            //skillHandlers.Add(6413, new SkillDefinations.Swordman.DFHitMeleeUp());
            skillHandlers.Add(6414, new SkillDefinations.Merchant.ASDEFUpOne());
            //skillHandlers.Add(6821, new SkillDefinations.Vates.MPHealing());
            //skillHandlers.Add(6420, new SkillDefinations.Merchant.BAtkUpOne());
            skillHandlers.Add(6418, new SkillDefinations.Swordman.ASParry());
            skillHandlers.Add(6430, new SkillDefinations.Assassin.BConcentricity());
            //skillHandlers.Add(6316, new SkillDefinations.Wizard.MPMagicShield());
            skillHandlers.Add(6805, new SkillDefinations.Swordman.ASAGIUp());
            skillHandlers.Add(6804, new SkillDefinations.Swordman.ASVITUp());
            skillHandlers.Add(6803, new SkillDefinations.Swordman.ASSTRUp());
            skillHandlers.Add(6822, new SkillDefinations.BladeMaster.ASPetMeditatioon());
            # endregion

            #region Passive Reply //被動回復技能塊
            skillHandlers.Add(7200, new SkillDefinations.Global.PRHPRecoverUP());
            skillHandlers.Add(7201, new SkillDefinations.Global.PRMPRecoverUP());
            skillHandlers.Add(7202, new SkillDefinations.Global.PRSPRecoverUP());
            #endregion

            #region Golden Wolf //金狼
            skillHandlers.Add(6839, new SkillDefinations.Striker.GWPetDogAtkCircle());
            skillHandlers.Add(6838, new SkillDefinations.Striker.GWPetDogHateUpCircle());
            skillHandlers.Add(6840, new SkillDefinations.Striker.GWPetDogDefUp());
            #endregion

            #region Blue Mercenary //青衣の傭兵
            skillHandlers.Add(6820, new SkillDefinations.Swordman.BMIai());
            skillHandlers.Add(6830, new SkillDefinations.BladeMaster.BMStormSword());
            //skillHandlers.Add(6413, new SkillDefinations.Swordman.DFHitMeleeUp());
            #endregion

            #region White Radish //白蘿蔔
            skillHandlers.Add(6845, new SkillDefinations.Blacksmith.WRFirstAid());
            #endregion

            #region Blue Kettering Cannon //藍色凱特林砲
            skillHandlers.Add(6841, new SkillDefinations.Blacksmith.BKCPetMacAtk());
            skillHandlers.Add(6842, new SkillDefinations.Blacksmith.BCKPetMacCircleAtk());
            //skillHandlers.Add(6413, new SkillDefinations.Swordman.DFHitMeleeUp());
            #endregion

            #region Moon Pegasus //ムーンペガサス
            skillHandlers.Add(6316, new SkillDefinations.Wizard.MPMagicShield());
            skillHandlers.Add(6317, new SkillDefinations.Swordman.MPCharge());
            skillHandlers.Add(6313, new SkillDefinations.Vates.MPLightOne());
            skillHandlers.Add(6821, new SkillDefinations.Vates.MPHealing());
            skillHandlers.Add(6817, new SkillDefinations.Vates.MPResurrection());
            #endregion

            #region Momomga //モモンガ
            //skillHandlers.Add(6417, new SkillDefinations.Scout.MAvoidMeleeUp());
            #endregion

            #region Poison Monga //ポイズンモモンガ
            skillHandlers.Add(6445, new SkillDefinations.Wizard.PMMagPoison());
            //skillHandlers.Add(6417, new SkillDefinations.Scout.MAvoidMeleeUp());
            #endregion

            //背負い魔・ネコマタ
            #region Alice //愛麗絲（アリス）
            skillHandlers.Add(6446, new SkillDefinations.Druid.AAreaHeal());
            skillHandlers.Add(6424, new SkillDefinations.Knight.ARevive());
            //skillHandlers.Add(6634, new SkillDefinations.Bard.ALoudSong());
            skillHandlers.Add(6448, new SkillDefinations.Druid.ASTR_VIT_AGI_UP());
            //skillHandlers.Add(6817, new SkillDefinations.Vates.MPResurrection());
            #endregion
            ...
            #region Emil's Hunter Heart //エミルの狩人ハート
            skillHandlers.Add(6612, new SkillDefinations.Striker.EHHPluralityArrow());
            skillHandlers.Add(6641, new SkillDefinations.Archer.EHHConArrow());
            skillHandlers.Add(6640, new SkillDefinations.Gunner.EHHChargeShot());
            //skillHandlers.Add(6446, new SkillDefinations.Druid.AAreaHeal());
            //skillHandlers.Add(6417, new SkillDefinations.Scout.ASAvoidMeleeUp());
            #endregion

            #region Hrock Bird  //ロック鳥(へヴィ)
            skillHandlers.Add(6847, new SkillDefinations.Striker.HBPetBirdAtk());
            //skillHandlers.Add(6413, new SkillDefinations.Swordman.DFHitMeleeUp());
            skillHandlers.Add(6846, new SkillDefinations.Striker.HBPetBirdAtkRowCircle2());
            #endregion

            #region White Witch 白色女巫(300港)技能
            skillHandlers.Add(6427, new SkillDefinations.Sorcerer.WWSolidAura());
            // skillHandlers.Add(6821, new SkillDefinations.Vates.MPHealing());
            // skillHandlers.Add(6420, new SkillDefinations.Merchant.AtkUpOne());
            skillHandlers.Add(6694, new SkillDefinations.Global.ElementWeapon(Elements.Holy));
            skillHandlers.Add(6630, new SkillDefinations.Sage.WWLuminaryNova());
            #endregion

            #region teddy //小泰迪
            skillHandlers.Add(6968, new SkillDefinations.Cabalist.TChgstRand());
            skillHandlers.Add(6969, new SkillDefinations.Swordman.TOverWork());
            skillHandlers.Add(6970, new SkillDefinations.Elementaler.TZen());
            skillHandlers.Add(6971, new SkillDefinations.Sorcerer.TStrVitAgiDownOne());
            skillHandlers.Add(6972, new SkillDefinations.Druid.TAreaHeal());
            skillHandlers.Add(6973, new SkillDefinations.Vates.TResurrection());
            skillHandlers.Add(6974, new SkillDefinations.BladeMaster.BDoubleCutDownSeq());//新手任務新增
            skillHandlers.Add(6966, new SkillDefinations.Knight.ARevive());//新手任務新增
            #endregion

            //2012
            #region Dark feather //ダークフェザー・アルマ(黑羽)
            skillHandlers.Add(6675, new SkillDefinations.Cabalist.DFGrimReaper());
           // skillHandlers.Add(6639, new SkillDefinations.Command.DFWildDance());
            skillHandlers.Add(6676, new SkillDefinations.DarkStalker.DFDarkMist());
            skillHandlers.Add(6314, new SkillDefinations.Swordman.DFStunBlow());
            skillHandlers.Add(6677, new SkillDefinations.Global.ElementWeapon(Elements.Dark));
            skillHandlers.Add(6412, new SkillDefinations.Swordman.DFATKUp());
            skillHandlers.Add(6413, new SkillDefinations.Swordman.DFHitMeleeUp());
            skillHandlers.Add(6674, new SkillDefinations.Cabalist.DFDarkStorm());
            #endregion

            #region Mutsuki's Shaman Heart //ムツキのシャーマンハート（朱）/守護魔・ムツキ
            //skillHandlers.Add(6446, new SkillDefinations.Druid.AAreaHeal());
            skillHandlers.Add(6312, new SkillDefinations.Monster.MSHSleepCircle());
            //skillHandlers.Add(6424, new SkillDefinations.Knight.Revive(2));
            //skillHandlers.Add(6448, new SkillDefinations.Druid.ASTR_VIT_AGI_UP());
            #endregion

            #region Baowu //バウ・アルマ(巴烏)
            skillHandlers.Add(6420, new SkillDefinations.Merchant.BAtkUpOne());
           // skillHandlers.Add(6430, new SkillDefinations.Assassin.BConcentricity());
           // skillHandlers.Add(6315, new SkillDefinations.BladeMaster.BPetWarCry());
            skillHandlers.Add(6808, new SkillDefinations.Swordman.BConfuseBlow());
            skillHandlers.Add(6800, new SkillDefinations.Swordman.BBanishBlow());
            skillHandlers.Add(6624, new SkillDefinations.BladeMaster.BDoubleCutDownSeq());
            skillHandlers.Add(6431, new SkillDefinations.Assassin.BConClaw());
            #endregion

            #region Kisaragi //キサラギの盗賊ハート跟守護魔・キサラギ
            //skillHandlers.Add(6630, new SkillDefinations.Sage.WWLuminaryNova());
            //skillHandlers.Add(6434, new SkillDefinations.Enchanter.MAGravityFall());
            //skillHandlers.Add(6506, new SkillDefinations.Warlock.MABlackWidow());
            //skillHandlers.Add(6314, new SkillDefinations.Swordman.DFStunBlow());
            //skillHandlers.Add(6419, new SkillDefinations.Swordman.SACounter());
            skillHandlers.Add(6433, new SkillDefinations.Sage.KMagHitUpCircle());
            #endregion

            #region Bud //萌芽
            //skillHandlers.Add(6821, new SkillDefinations.Vates.MPHealing());
            //skillHandlers.Add(6420, new SkillDefinations.Merchant.BAtkUpOne());
            skillHandlers.Add(6826, new SkillDefinations.Cabalist.BudFGrimReaper());
            //skillHandlers.Add(6414, new SkillDefinations.Merchant.ASDEFUpOne());
            //skillHandlers.Add(6412, new SkillDefinations.Swordman.DFATKUp());
            //skillHandlers.Add(6445, new SkillDefinations.Wizard.PMMagPoison());
            skillHandlers.Add(6678, new SkillDefinations.Enchanter.BudGravityFall());
            skillHandlers.Add(6679, new SkillDefinations.Merchant.BudVITDEFDown());
            skillHandlers.Add(6680, new SkillDefinations.DarkStalker.BudLifeSteal());

            #endregion

            #region Ykfh //彌生的功夫心
            skillHandlers.Add(6416, new SkillDefinations.Scout.YkfhCriUp());
            //skillHandlers.Add(6625, new SkillDefinations.BountyHunter.ASIsSeN());
            //skillHandlers.Add(6314, new SkillDefinations.Swordman.DFStunBlow());
            //skillHandlers.Add(6419, new SkillDefinations.Swordman.SACounter());
            //skillHandlers.Add(6418, new SkillDefinations.Swordman.ASParry());
            ...
            #region Ruruie's Amaenbo Heart //露瑞耶的阿曼波之心
            //skillHandlers.Add(6818, new SkillDefinations.Shaman.MAIceArrow());
            //skillHandlers.Add(6446, new SkillDefinations.Druid.AAreaHeal());
            //skillHandlers.Add(6448, new SkillDefinations.Druid.ASTR_VIT_AGI_UP());
            //skillHandlers.Add(6424, new SkillDefinations.Knight.Revive(2));
            ...
            #region LowKey //ローキー・アルマ
            skillHandlers.Add(6681, new SkillDefinations.Gladiator.LKConvolution());
            #endregion
            #region Uzuki'sChildRenHeart //ウヅキのチルドレンハート
            skillHandlers.Add(6609, new SkillDefinations.BountyHunter.UCRHMiNeUChi());
            #endregion
            #region Barul Alma //バルル・アルマ
            skillHandlers.Add(6848, new SkillDefinations.Monster.BAStunAttack());
            skillHandlers.Add(6849, new SkillDefinations.BountyHunter.BAAShiBaRaI());
            #endregion
            #region Marsha's Kunoichi Heart //マーシャのくのいちハート
            skillHandlers.Add(6619, new SkillDefinations.Warlock.MKHBlackWidow());
            //skillHandlers.Add(6639, new SkillDefinations.Command.ASWildDance());
            //skillHandlers.Add(6611, new SkillDefinations.Assassin.MHKScatterPoison());
            //skillHandlers.Add(6430, new SkillDefinations.Assassin.BConcentricity());
            skillHandlers.Add(6441, new SkillDefinations.Explorer.MHKAbsorbSpWeapon());
            //skillHandlers.Add(6418, new SkillDefinations.Swordman.ASParry());
            //skillHandlers.Add(6417, new SkillDefinations.Scout.ASAvoidMeleeUp());
            #endregion
            #region Satsuki's Fairy Heart //雨月的仙女之心
            //skillHandlers.Add(6630, new SkillDefinations.Sage.WWLuminaryNova());
            skillHandlers.Add(6824, new SkillDefinations.Shaman.SFHFireBolt());
            //skillHandlers.Add(6818, new SkillDefinations.Shaman.MAIceArrow());
            //skillHandlers.Add(6826, new SkillDefinations.Cabalist.BudFGrimReaper());
            //skillHandlers.Add(6417, new SkillDefinations.Scout.ASAvoidMeleeUp());
            //skillHandlers.Add(6420, new SkillDefinations.Merchant.BAtkUpOne());
            #endregion 
            #region  Seahorse alma //シーホース・アルマ
            //skillHandlers.Add(6061, new SkillDefinations.Global.MAElementStorm(Elements.Water));
            skillHandlers.Add(6682, new SkillDefinations.Assassin.SABConClaw());
            //skillHandlers.Add(6316, new SkillDefinations.Wizard.MPMagicShield());
            skillHandlers.Add(6684, new SkillDefinations.Elementaler.SAWaterGroove());
            #endregion
            #region Minazuki's Elegant Heart//水無月的優雅之心
            skillHandlers.Add(6426, new SkillDefinations.Necromancer.MEHAbsorbHpWeapon());
            skillHandlers.Add(6422, new SkillDefinations.Alchemist.MEHSuper_A_T_PJoint());//强力援手
            //skillHandlers.Add(6424, new SkillDefinations.Knight.Revive(2));
            //skillHandlers.Add(6821, new SkillDefinations.Vates.MPHealing());
            //skillHandlers.Add(6414, new SkillDefinations.Merchant.ASDEFUpOne());
            //skillHandlers.Add(6420, new SkillDefinations.Merchant.BAtkUpOne());
            #endregion
            #region Pepen Alma //ペペン・アルマ
            //skillHandlers.Add(6821, new SkillDefinations.Vates.MPHealing());
            //skillHandlers.Add(6433, new SkillDefinations.Sage.KMagHitUpCircle());
            //skillHandlers.Add(6818, new SkillDefinations.Shaman.MAIceArrow());
            skillHandlers.Add(6691, new SkillDefinations.Monster.PAWaterAttack());
            skillHandlers.Add(6688, new SkillDefinations.Monster.PAIceFade());
            skillHandlers.Add(6689, new SkillDefinations.Monster.MobElementLoad(7665));//凍結的路
            skillHandlers.Add(6692, new SkillDefinations.BountyHunter.PAEdgedSlash());
            #endregion
            #region Fumitsuki's Pretty Heart//涼月的美麗之心
            //skillHandlers.Add(6624, new SkillDefinations.BladeMaster.BDoubleCutDownSeq());
            //skillHandlers.Add(6619, new SkillDefinations.Warlock.MKHBlackWidow());
            //skillHandlers.Add(6314, new SkillDefinations.Swordman.DFStunBlow());
            //skillHandlers.Add(6818, new SkillDefinations.Shaman.MAIceArrow());
            skillHandlers.Add(6610, new SkillDefinations.Sorcerer.FPHEnergyBarrier());
            //skillHandlers.Add(6420, new SkillDefinations.Merchant.BAtkUpOne());
            #endregion
            #region Salamander Alma//サラマンダー・アルマ
            // skillHandlers.Add(6812, new SkillDefinations.Shaman.MAFireBlast());
            skillHandlers.Add(6850, new SkillDefinations.Global.ElementStorm(Elements.Fire));
            skillHandlers.Add(6852, new SkillDefinations.Wizard.SAEnergyShield());
            //skillHandlers.Add(6824, new SkillDefinations.Shaman.SFHFireBolt());
            skillHandlers.Add(6851, new SkillDefinations.ForceMaster.SAShockWave());//11月26日实装,lv45
            #endregion
            #region Hazuki's Cyber ​​Heart//清月的網路之心
            skillHandlers.Add(6618, new SkillDefinations.Gunner.HCHClothCrest());
            skillHandlers.Add(6614, new SkillDefinations.Gunner.HCHBurstShot());
            skillHandlers.Add(6601, new SkillDefinations.Druid.HCHCureAll());
            //skillHandlers.Add(6430, new SkillDefinations.Assassin.BConcentricity());
            //skillHandlers.Add(6610, new SkillDefinations.Sorcerer.FPHEnergyBarrier());
            #endregion

            #region Kikuzuki's Guardian Demon heart//菊月的守護魔心
            skillHandlers.Add(6626, new SkillDefinations.TreasureHunter.KGDConthWhip());
            skillHandlers.Add(6629, new SkillDefinations.TreasureHunter.KGDBackRush());
            skillHandlers.Add(6825, new SkillDefinations.Shaman.KGDThunderBall());
            //skillHandlers.Add(6821, new SkillDefinations.Vates.MPHealing());
            //skillHandlers.Add(6420, new SkillDefinations.Merchant.BAtkUpOne());
            #endregion

            #region Nagatsuki's Guardian heart//長月的守護之心
            skillHandlers.Add(6606, new SkillDefinations.BountyHunter.NGMuSoU());
            skillHandlers.Add(6437, new SkillDefinations.BountyHunter.NGGravity()); ;
            //skillHandlers.Add(6825, new SkillDefinations.Shaman.KGDThunderBall());
            // skillHandlers.Add(6314, new SkillDefinations.Swordman.DFStunBlow());
            // skillHandlers.Add(6620, new SkillDefinations.Blacksmith.ASEearthCrash());
            //skillHandlers.Add(6821, new SkillDefinations.Vates.MPHealing());
            ...
            #region White Familiar Alma//白い使い魔・アルマ
            //skillHandlers.Add(6424, new SkillDefinations.Knight.Revive(2));
            //skillHandlers.Add(6446, new SkillDefinations.Druid.AAreaHeal());
            //skillHandlers.Add(6852, new SkillDefinations.Wizard.SAEnergyShield());
            //skillHandlers.Add(6680, new SkillDefinations.DarkStalker.BudLifeSteal());
            ...
            //
            //
            skillHandlers.Add(6697, new SkillDefinations.Cardinal.WFAngelRing());//11月30日实装,lv30
            #endregion

            #region Tita's Adventure Heart//蒂塔的冒險之心
            skillHandlers.Add(6063, new SkillDefinations.Cabalist.TAHTChgstRand());
            skillHandlers.Add(6829, new SkillDefinations.Swordman.TAHBlow());
            #endregion

            #region Automedic Alma//オートメディック・アルマ
            skillHandlers.Add(6706, new SkillDefinations.Global.AAElementWeapon(Elements.Fire));
            skillHandlers.Add(6707, new SkillDefinations.Assassin.AAPosionNeedle());
            skillHandlers.Add(6708, new SkillDefinations.Sorcerer.AADevineBarrier());
            skillHandlers.Add(6709, new SkillDefinations.Druid.AACureAll());
            #endregion

            #region AMNESIA Partner//AMNESIAの精霊・オリオン
            skillHandlers.Add(6698, new SkillDefinations.Merchant.APBAtkUpOne());
            skillHandlers.Add(6705, new SkillDefinations.Sorcerer.APDevineBarrier());
            skillHandlers.Add(6704, new SkillDefinations.Knight.APARevive());
            skillHandlers.Add(6703, new SkillDefinations.Druid.APASTR_VIT_AGI_UP());
            skillHandlers.Add(6701, new SkillDefinations.Sorcerer.APWWSolidAura());
            skillHandlers.Add(6699, new SkillDefinations.Vates.APMPHealing());
            skillHandlers.Add(6700, new SkillDefinations.Druid.APAllHealing());
            skillHandlers.Add(6702, new SkillDefinations.Vates.APTResurrection());
            #endregion

            #region Death Alma //デス・アルマ
            skillHandlers.Add(6712, new SkillDefinations.SoulTaker.DADeathSickle());//11月30实装,lv40
            skillHandlers.Add(6713, new SkillDefinations.Necromancer.MEHAbsorbHpWeapon());
            skillHandlers.Add(6714, new SkillDefinations.Marionest.DAPuppet());
            #endregion

            skillHandlers.Add(6429, new SkillDefinations.Swordman.POverWork());//寵物用-延遲取消

            #region Alucard Roa //アルカード・ロア
            skillHandlers.Add(6827, new SkillDefinations.DarkStalker.ARDarkVacuum());
            //skillHandlers.Add(6676, new SkillDefinations.DarkStalker.DFDarkMist());
            skillHandlers.Add(6717, new SkillDefinations.DarkStalker.ARBloodAbsrd());
            skillHandlers.Add(6718, new SkillDefinations.Cabalist.AREventSelfDarkStorm());//阿露卡多专用技能
            skillHandlers.Add(6719, new SkillDefinations.Necromancer.AREvilSoul());
            skillHandlers.Add(6720, new SkillDefinations.Cabalist.ARSoulSteal());
            #endregion

            #region Angel Feather Alma //エンジェルフェザー・アルマ
            // skillHandlers.Add(6313, new SkillDefinations.Vates.MPLightOne());
            // skillHandlers.Add(6817, new SkillDefinations.Vates.MPResurrection());
            // skillHandlers.Add(6448, new SkillDefinations.Druid.ASTR_VIT_AGI_UP());
            skillHandlers.Add(6721, new SkillDefinations.Cardinal.AFAAngelRing());//11月30日实装,lv30
            skillHandlers.Add(6722, new SkillDefinations.Cardinal.AFASalvation()); // 16.01.08实装,lv47
            skillHandlers.Add(6723, new SkillDefinations.Elementaler.AFAHolyGroove());
            #endregion

            #region Kiyohime Roa //清姫・ロア
            skillHandlers.Add(6726, new SkillDefinations.Assassin.KRAAPosionNeedle());
            //skillHandlers.Add(6724, new SkillDefinations.Elementaler.KRLavaFlow());
            skillHandlers.Add(6725, new SkillDefinations.Druid.KRASTR_VIT_AGI_UP());
            #endregion

            #region LeFay Roi //ル・フェイ・ロア
            skillHandlers.Add(6859, new SkillDefinations.Cardinal.LFRRecovery());//11月30日实装,lv40
            skillHandlers.Add(6727, new SkillDefinations.Enchanter.LFRGravityFall());
            skillHandlers.Add(6728, new SkillDefinations.Cabalist.LFRSleepCloud());
            skillHandlers.Add(6729, new SkillDefinations.Sorcerer.LFRDevineBarrier());
            #endregion

            #region NecroArmor Alma //ネクロアーマー・アルマ
            skillHandlers.Add(6730, new SkillDefinations.Monster.NAAMobCharge3());
            skillHandlers.Add(6731, new SkillDefinations.BountyHunter.NAAStrikeBlow());
            skillHandlers.Add(6732, new SkillDefinations.Guardian.NAAShieldImpact());//11月24日实装，lv30习得
            #endregion

            #region Bastet Roa //バステト・ロア
            skillHandlers.Add(6632, new SkillDefinations.Necromancer.BRSummobLemures());
            skillHandlers.Add(6737, new SkillDefinations.Druid.BRAAreaHeal());
            skillHandlers.Add(6736, new SkillDefinations.Swordman.BRDFATKUpASDEFUpOne());
            skillHandlers.Add(6733, new SkillDefinations.BountyHunter.BRMuSoU());
            #endregion

            #region Umbrella Alma //アンブレラ・アルマ
            skillHandlers.Add(6853, new SkillDefinations.Assassin.UABackAtk());
            skillHandlers.Add(6739, new SkillDefinations.ForceMaster.UASAShockWave());//11月26日实装,lv45
            skillHandlers.Add(6738, new SkillDefinations.Cabalist.UAStoneSkin());
            #endregion

            // skillHandlers.Add(26227, new SkillDefinations.Vates.sakura());//ECOKEY 小櫻技能
            skillHandlers.Add(5536, new SkillDefinations.ECOKEY.SakuraSeal());//ECOKEY 小櫻技能-卡牌封印
            skillHandlers.Add(5537, new SkillDefinations.ECOKEY.SakuraPowerUp());//ECOKEY 小櫻技能-封印解除

            //呀哈哈-草神
            skillHandlers.Add(26999, new SkillDefinations.ECOKEY.YHHDefdown());
            skillHandlers.Add(27001, new SkillDefinations.ECOKEY.YHHMistletoeShooting());
            skillHandlers.Add(27002, new SkillDefinations.ECOKEY.YHHPlantField());
            skillHandlers.Add(27003, new SkillDefinations.ECOKEY.YHHTwistedPlant());
            skillHandlers.Add(27004, new SkillDefinations.Global.ElementWeapon(Elements.Earth));

            //紫劍DEM-絲維爾•娜特
            skillHandlers.Add(27005, new SkillDefinations.ECOKEY.SNDarkSword());
            skillHandlers.Add(27006, new SkillDefinations.ECOKEY.SNWindSword());
            skillHandlers.Add(27007, new SkillDefinations.ECOKEY.SNAtkMinToMax());
            skillHandlers.Add(27008, new SkillDefinations.ECOKEY.SNOverclock());
            skillHandlers.Add(27009, new SkillDefinations.ECOKEY.SNFixHealing());

            //黑甲DEM-絲維爾•緹亞
            skillHandlers.Add(27010, new SkillDefinations.ECOKEY.STWindMagic());
            skillHandlers.Add(27011, new SkillDefinations.ECOKEY.STBoomSelf());
            skillHandlers.Add(27012, new SkillDefinations.ECOKEY.STPrecisionFire());
            //skillHandlers.Add(27008, new SkillDefinations.ECOKEY.SNOverclock());
            //skillHandlers.Add(27009, new SkillDefinations.ECOKEY.SNFixHealing());

            //白盾
            skillHandlers.Add(6975, new SkillDefinations.Druid.ASTR_VIT_AGI_UP());
            skillHandlers.Add(6976, new SkillDefinations.Assassin.BConcentricity());
            skillHandlers.Add(6977, new SkillDefinations.BountyHunter.NGMuSoU());
            skillHandlers.Add(6980, new SkillDefinations.Swordman.POverWork());//寵物用-延遲取消
            skillHandlers.Add(6981, new SkillDefinations.Global.ElementWeapon1(Elements.Holy));

            //黑盾
            skillHandlers.Add(8092, new SkillDefinations.Druid.BMAG_INT_DEX_UP()); //心靈豐足
            skillHandlers.Add(8093, new SkillDefinations.Druid.DarkFeather());
            skillHandlers.Add(8095, new SkillDefinations.BountyHunter.BNGMuSoU()); //連擊更高傷
            skillHandlers.Add(8096, new SkillDefinations.Global.ElementWeapon1(Elements.Dark)); //暗ドロップ強化
            //skillHandlers.Add(6973, new SkillDefinations.Vates.TResurrection()); //復活
            //skillHandlers.Add(6970, new SkillDefinations.Elementaler.TZen()); //極大

            skillHandlers.Add(1608, new SkillDefinations.Global.糊塗的祝福());//糊塗的祝福

            #region Captain Kidd Roa //キャプテンキッド・ロア
            skillHandlers.Add(6740, new SkillDefinations.Hawkeye.CKRPointRain());//▲ふぁいあー♪
            skillHandlers.Add(6742, new SkillDefinations.Gunner.CKRVitalShot());//▲バイタルショット
           // skillHandlers.Add(6743, new SkillDefinations.Gunner.CKRPluralityShot());//▲ばきゅん♪
            skillHandlers.Add(6745, new SkillDefinations.Gunner.CKRGrenadeShot());//▲ぶちかますわよん♪
            #endregion
            #region Cococo Alma //ココッコー・アルマ
            skillHandlers.Add(6746, new SkillDefinations.Druid.BRAAreaHeal());//▲ぴいにもできること、やる！
            skillHandlers.Add(6747, new SkillDefinations.BountyHunter.PAEdgedSlash());//▲こわい……っ おなかいたいぃ
            skillHandlers.Add(6748, new SkillDefinations.Gunner.CKRPluralityShot());//▲ピ？
            skillHandlers.Add(6749, new SkillDefinations.Cardinal.CAAngelRing());//▲こわいのこないでえ……！
            #endregion
            #region Tamamo Roa //玉藻・ロア
           // skillHandlers.Add(6757, new SkillDefinations.Assassin.MHKScatterPoison());//▲九尾狐の殺生石☆体験版
            skillHandlers.Add(6758, new SkillDefinations.Gladiator.LKConvolution());//▲お仕置き、だよ♪
            skillHandlers.Add(6759, new SkillDefinations.Sorcerer.TRDevineBarrier());//▲神格強化☆狐狸夢中
            skillHandlers.Add(6760, new SkillDefinations.Druid.TRCureAll());//▲九尾の霊験☆復刻版
            #endregion
            #region Tarantula Alma //タランチュラ・アルマ
            skillHandlers.Add(6750, new SkillDefinations.Blacksmith.TAMarlesisShadow());//▲じっとしてなさい！
            skillHandlers.Add(6751, new SkillDefinations.Eraser.VenomBlast());//▲これでもくらいなさい！
            skillHandlers.Add(6753, new SkillDefinations.BountyHunter.PAEdgedSlash());//▲私が咬むと痛いのよ？
            skillHandlers.Add(6754, new SkillDefinations.Sorcerer.TAMagicBarrier());//▲あなたの援護は私がするわ
            skillHandlers.Add(6755, new SkillDefinations.BountyHunter.TABrandish());//▲私が行きます！
            #endregion
            #region Lorelei Roa //ローレライ・ロア
            skillHandlers.Add(6765, new SkillDefinations.Bard.MFLDeadMarch());//▲さよならランデヴー
            skillHandlers.Add(6766, new SkillDefinations.Bard.Relaxation());//▲いえす！らぶりー♪ますたー☆
            skillHandlers.Add(6767, new SkillDefinations.Wizard.LREnergyShield());//▲もりあがっていきましょう
            skillHandlers.Add(6768, new SkillDefinations.Bard.BardSession());//▲ぐったりしていきましょう
            #endregion

            //武神技能補充
            skillHandlers.Add(7771, new SkillDefinations.Event.CriUpSticks());
            skillHandlers.Add(7802, new SkillDefinations.Monster.LavaFlow());
            skillHandlers.Add(7646, new SkillDefinations.Elementaler.AFAHolyGroove());
            skillHandlers.Add(7872, new SkillDefinations.Monster.WeaponRemove());
            skillHandlers.Add(7834, new SkillDefinations.Monster.Catch());
            skillHandlers.Add(7866, new SkillDefinations.Monster.SomaMirage());
            skillHandlers.Add(7763, new SkillDefinations.Monster.CyclOne());//武神更改

            #region Lili's Valkyrie Heart //莉莉的瓦爾基里之心
            skillHandlers.Add(6622, new SkillDefinations.Scout.LVHConThrust());
            skillHandlers.Add(6832, new SkillDefinations.Knight.LVHAppeal());
            #endregion

            skillHandlers.Add(5533, new SkillDefinations.Global.NekoBlue());//生命復位
            skillHandlers.Add(5534, new SkillDefinations.Global.NekoPurple());//魔法復位
            skillHandlers.Add(5535, new SkillDefinations.Global.NekoOrange());//耐力復位

            skillHandlers.Add(27013, new SkillDefinations.Global.SpeedupDog());

            #region Bear Alma //ベア・アルマ
            skillHandlers.Add(6769, new SkillDefinations.Monster.BAExciaMation());
            //skillHandlers.Add(8071, new SkillDefinations.Swordman.KNFurious()); //notwell
            skillHandlers.Add(6771, new SkillDefinations.Enchanter.BALFRGravityFall());
            skillHandlers.Add(6772, new SkillDefinations.Knight.BALVHAppeal());
            #endregion

            #region Paracelsus Loa //パラケルスス・ロア
            skillHandlers.Add(6507, new SkillDefinations.Sorcerer.PLTAMagicBarrier());
            skillHandlers.Add(6780, new SkillDefinations.Shaman.PLThunderBall());
            skillHandlers.Add(6782, new SkillDefinations.Cabalist.PLSoulSteal());
            // skillHandlers.Add(6772, new SkillDefinations.Knight.BALVHAppeal()); //notwell
            #endregion


            #region Fly Fish Alma //フライフィッシュ・アルマ
            skillHandlers.Add(6774, new SkillDefinations.BountyHunter.FFAEdgedSlash());
            skillHandlers.Add(6775, new SkillDefinations.Shaman.FFAIceArrow());
            skillHandlers.Add(6777, new SkillDefinations.Warlock.FFAMagSleep());
            skillHandlers.Add(6778, new SkillDefinations.BountyHunter.FFAGravity());
            skillHandlers.Add(6779, new SkillDefinations.Warlock.FFAMagFreeze());
            #endregion
            #region Werewolf Lore //ワーウルフ・ロア
            skillHandlers.Add(6789, new SkillDefinations.BountyHunter.FFAEdgedSlash());
            skillHandlers.Add(6790, new SkillDefinations.Gladiator.WLPressure());
            skillHandlers.Add(6791, new SkillDefinations.Assassin.WLBackAtk());
            skillHandlers.Add(6792, new SkillDefinations.TreasureHunter.WLWarn());
            #endregion

            skillHandlers.Add(9006, new SkillDefinations.Global.top1());//陀螺
            skillHandlers.Add(9007, new SkillDefinations.Global.top2());//陀螺2
            skillHandlers.Add(9250, new SkillDefinations.Global.SumKitty());//陽夜子
            skillHandlers.Add(9251, new SkillDefinations.Global.SumKittyCont());//陽夜子

            #region Tentacle Alma //テンタクル・アルマ
            skillHandlers.Add(6793, new SkillDefinations.Scout.LVHConThrust());
            skillHandlers.Add(6795, new SkillDefinations.Shaman.MAFireBlast());
            skillHandlers.Add(6796, new SkillDefinations.Swordman.TASlowBlow());
            skillHandlers.Add(6797, new SkillDefinations.Swordman.DFStunBlow(true));
            skillHandlers.Add(6798, new SkillDefinations.Druid.AACureAll());
            #endregion

            #region Mess Fletcher Loa //メフィストフェレス・ロア
            skillHandlers.Add(6799, new SkillDefinations.Machinery.MFLRobotLovageCannon());
            skillHandlers.Add(6862, new SkillDefinations.Bard.MFLDeadMarch());
            skillHandlers.Add(6863, new SkillDefinations.Sorcerer.APDevineBarrier());
            #endregion

            #region Mommy Aruma //マミー・アルマ
            skillHandlers.Add(6864, new SkillDefinations.Enchanter.MAGravityFallPoison());
            skillHandlers.Add(6865, new SkillDefinations.BladeMaster.BDoubleCutDownSeq());
            skillHandlers.Add(6866, new SkillDefinations.Sorcerer.FPHEnergyBarrier());//沒buff應該有效、以修
            skillHandlers.Add(6867, new SkillDefinations.Necromancer.DarkFlare());
            skillHandlers.Add(6868, new SkillDefinations.Vates.MPHealing());
            #endregion

            #region Lucifer Roa //ルチフェロ・ロア
            skillHandlers.Add(6869, new SkillDefinations.BountyHunter.TABrandish());
            skillHandlers.Add(6871, new SkillDefinations.Alchemist.ASPhalanx());
            skillHandlers.Add(6872, new SkillDefinations.Necromancer.DarkFlare());
            //skillHandlers.Add(6412, new SkillDefinations.Swordman.DFATKUp());
            //skillHandlers.Add(6677, new SkillDefinations.Global.ElementWeapon(Elements.Dark));
            #endregion

            #region Drakky Alma //ドラッキー・アルマ
            skillHandlers.Add(6873, new SkillDefinations.Trader.DASennpuuken());
            skillHandlers.Add(6874, new SkillDefinations.Eraser.DAShadowSeam());
            skillHandlers.Add(6875, new SkillDefinations.Scout.ASAvoidMeleeUp());
            #endregion

            #region Stella Roa //ステラ・ロア
            skillHandlers.Add(6876, new SkillDefinations.Druid.AAreaHeal());
            skillHandlers.Add(6877, new SkillDefinations.Knight.ARevive());
            skillHandlers.Add(6878, new SkillDefinations.Druid.AACureAll());
            skillHandlers.Add(6879, new SkillDefinations.Enchanter.SpeedEnchant());
            skillHandlers.Add(6880, new SkillDefinations.Sorcerer.AADevineBarrier());
            skillHandlers.Add(6887, new SkillDefinations.Druid.APAllHealing());
            #endregion

            #region Boeuf Alma //ブーフ・アルマ
            skillHandlers.Add(6881, new SkillDefinations.Wizard.BAEnergyBlast());
            skillHandlers.Add(6883, new SkillDefinations.Vates.MPHealing());
            skillHandlers.Add(6884, new SkillDefinations.Astralist.BAWindExplosion());
            skillHandlers.Add(6885, new SkillDefinations.ForceMaster.BAShockWave());
            skillHandlers.Add(6886, new SkillDefinations.Sorcerer.BAStrVitAgiDownOne());
            #endregion
