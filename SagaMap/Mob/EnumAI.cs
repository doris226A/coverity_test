...
namespace SagaMap.Mob
{
    ...
    public class AIMode
    {
        ...
        uint eventdieskill;
        int eventdieskillrate;

        /// <summary>
        /// 怪物死掉時，會施放的技能
        /// </summary>
        public uint EventDieSkill { get { return this.eventdieskill; } set { this.eventdieskill = value; } }

        /// <summary>
        /// 怪物死掉時，施放技能的機率
        /// </summary>
        public int EventDieSkillRate { get { return this.eventdieskillrate; } set { this.eventdieskillrate = value; } }
    }
}
