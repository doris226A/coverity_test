...
namespace SagaMap.Manager
{
    public class TamaireLendingManager : Singleton<TamaireLendingManager>
    {
        ...
        private void UpdateLending(TamaireLending lending)
        {
            ...
            if (lender.TamaireLending != null)
            {
                ...
                lender.TamaireLending.Name = lending.Name;
    ...
    public class TamaireRentalManager : Singleton<TamaireRentalManager>
    {
        ...
        //新增，清除心的素質
        void TamaireClear(ActorPC renter)
        {
            ...
            renter.TamaireRental.payload = 0;
            renter.TamaireRental.capacity = 0;
        }
        //租心
        ...
        public void ProcessRentalStatus(ActorPC renter, int leveldiff, byte jobtype)
        {
            ...
            if (status != null)
            {
                ...
                renter.TamaireRental.payload = (short)(status.payload * factor);
                renter.TamaireRental.capacity = (short)(status.capacity * factor);
            }
            else
            {
                renter.TamaireRental.hp = 0;
    ...
    public class TamaireExperienceMagager : Singleton<TamaireExperienceMagager>
    {
        ...
        {
            if (pc.TamaireLending == null || pc.TamaireLending.Renters.Count == 0)
                return;

            //一天只能領一次經驗值，12點為標準
            DateTime start = DateTime.Now;
            string str = start.ToString("yyyy-MM-dd");
            if (pc.CStr["TamaireExp"] == str)
                return;
            pc.CStr["TamaireExp"] = str;
