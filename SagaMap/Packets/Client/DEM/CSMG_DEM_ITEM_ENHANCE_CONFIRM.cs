...
{
    public class CSMG_DEM_ITEM_ENHANCE_CONFIRM : Packet
    {
        public CSMG_DEM_ITEM_ENHANCE_CONFIRM()
        {
            this.offset = 2;
        }
        ...
        {
            return (SagaLib.Packet)new SagaMap.Packets.Client.CSMG_DEM_ITEM_ENHANCE_CONFIRM();
        }

        public override void Parse(SagaLib.Client client)
        {
            ((MapClient)(client)).OnItemEnhanceConfirmDEM(this);
        }
