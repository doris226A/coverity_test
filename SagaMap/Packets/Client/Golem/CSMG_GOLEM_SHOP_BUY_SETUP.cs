...
namespace SagaMap.Packets.Client
{
    public class CSMG_GOLEM_SHOP_BUY_SETUP : Packet
    {
        ...
        public ulong BuyLimit
        {
            ...
            {
               byte len = GetByte(2);
               return this.GetULong((ushort)(5 + len * 14));
            }
        }
        ...
        public string Comment
        {
            ...
            {
                byte len = GetByte(2);
                len = GetByte((ushort)(13 + len * 14));
                return Global.Unicode.GetString(GetBytes(len, (ushort)(14 + GetByte(2) * 14))).Replace("\0", "");
            }
        }

        public byte GelomShopType
        {
            get
            {
                return this.GetByte();
