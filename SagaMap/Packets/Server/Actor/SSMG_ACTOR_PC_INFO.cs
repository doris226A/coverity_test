        ...
        ActorShadow SetShadow
        {
            set
            {
                ...
                if (Configuration.Instance.Version >= SagaLib.Version.Saga17)
                {
                    ...
                    ////////////////玩家外观////////////////
                    if (value.Owner.Marionette == null && value.PictID == 0)//ECOKEY 召喚物新增判斷
                    {
                        this.PutByte((byte)value.Owner.Race, offset);
                        ...
                        this.PutByte(0xff, offset + 8); //原先前面有加//
                    ...
                    if (value.PictID != 0)
                    {
                        this.PutUInt(value.PictID, offset + 16);
                    }
                    else if (value.Owner.Marionette == null)
                    {
                    ...
                    //ECOKEY 這一大段註解掉，配合下面的修復，這段會導致召喚物變透明
                    /*
                    ////////////////队伍信息////////////////
                    ...
                    */
                    //ECOKEY 修復特定狀況，會使召喚物變透明的問題 
                    this.PutByte(1, offset + 90);
                    this.PutByte(1, offset + 92);
                    this.PutByte(1, offset + 97);
                    this.PutByte(1, offset + 99);
                    buf = Global.Unicode.GetBytes("");
                    buff = new byte[this.data.Length + buf.Length];
                    this.data.CopyTo(buff, 0);
                    this.data = buff;
                    this.PutByte((byte)buf.Length, offset + 100);
                    ...
                    if (value.PictID != 0)
                    {
                        this.PutUInt(4, offset + 105);
                    }
                    else
                    {
                        this.PutUInt(2, offset + 105); // shadow size [1-5]
                    }

                    this.PutUShort((ushort)value.Owner.Motion, offset + 109);

                    this.PutUInt(2, offset + 111);//unknown
                ...
                if (Configuration.Instance.Version >= SagaLib.Version.Saga9 && Configuration.Instance.Version < SagaLib.Version.Saga14_2)
                {
                    ...
                    switch (value.Mode)
                    {
                        ...
                        case PlayerMode.WRP:
                            ...
                            break;
                        #region "大逃殺專用"
                        case PlayerMode.BATTLE_SOUTH:
                            this.PutUInt(0x22, (ushort)(offset + 116));//mode1
                            this.PutUInt(2, (ushort)(offset + 120));//mode2
                            this.PutUInt(4, (ushort)(offset + 124));//emblem; //演習時のエンブレムとか　1東2西4南8北A(44)(20)ヒーロー状態(12無法戰鬥)
                            //this.PutInt(0, (ushort)(offset + 115));//metamo; //メタモーバトルのチーム　1花2岩
                            break;
                        case PlayerMode.BATTLE_NORTH:
                            this.PutUInt(0x22, (ushort)(offset + 116));//mode1
                            this.PutUInt(2, (ushort)(offset + 120));//mode2
                            this.PutUInt(8, (ushort)(offset + 124));//emblem; //演習時のエンブレムとか　1東2西4南8北A(56)(24)ヒーロー状態
                            //this.PutInt(0, (ushort)(offset + 115));//metamo; //メタモーバトルのチーム　1花2岩
                            break;
                        #endregion
                        #region "騎士團專用"
                        case PlayerMode.KNIGHT_EAST:
                            this.PutUInt(0x22, (ushort)(offset + 116));//mode1
                            this.PutUInt(2, (ushort)(offset + 120));//mode2
                            this.PutUInt(1, (ushort)(offset + 124));//emblem; //演習時のエンブレムとか　1東2西4南8北A(41 43 45 47 49)(17)ヒーロー状態48 16無所屬(9無法戰鬥)
                            //this.PutInt(0, (ushort)(offset + 115));//metamo; //メタモーバトルのチーム　1花2岩
                            break;
                        case PlayerMode.KNIGHT_WEST:
                            this.PutUInt(0x22, (ushort)(offset + 116));//mode1
                            this.PutUInt(2, (ushort)(offset + 120));//mode2
                            this.PutUInt(2, (ushort)(offset + 124));//emblem; //演習時のエンブレムとか　1東2西4南8北A(42 46)(18)ヒーロー状態(10無法戰鬥)
                            //this.PutInt(0, (ushort)(offset + 115));//metamo; //メタモーバトルのチーム　1花2岩
                            break;
                        ...
                        case PlayerMode.KNIGHT_EAST_HERO:
                            this.PutUInt(0x22, (ushort)(offset + 116));//mode1
                            this.PutUInt(2, (ushort)(offset + 120));//mode2
                            this.PutUInt(17, (ushort)(offset + 124));//emblem; //演習時のエンブレムとか　1東2西4南8北A(17)ヒーロー状態48 16無所屬
                            //this.PutInt(0, (ushort)(offset + 115));//metamo; //メタモーバトルのチーム　1花2岩
                            break;
                        case PlayerMode.KNIGHT_WEST_HERO:
                            this.PutUInt(0x22, (ushort)(offset + 116));//mode1
                            this.PutUInt(2, (ushort)(offset + 120));//mode2
                            this.PutUInt(18, (ushort)(offset + 124));//emblem; //演習時のエンブレムとか　1東2西4南8北A(18)ヒーロー状態
                            //this.PutInt(0, (ushort)(offset + 115));//metamo; //メタモーバトルのチーム　1花2岩
                            break;
                        case PlayerMode.KNIGHT_SOUTH_HERO:
                            this.PutUInt(0x22, (ushort)(offset + 116));//mode1
                            this.PutUInt(2, (ushort)(offset + 120));//mode2
                            this.PutUInt(20, (ushort)(offset + 124));//emblem; //演習時のエンブレムとか　1東2西4南8北A(20)ヒーロー状態
                            //this.PutInt(0, (ushort)(offset + 115));//metamo; //メタモーバトルのチーム　1花2岩
                            break;
                        case PlayerMode.KNIGHT_NORTH_HERO:
                            this.PutUInt(0x22, (ushort)(offset + 116));//mode1
                            this.PutUInt(2, (ushort)(offset + 120));//mode2
                            this.PutUInt(24, (ushort)(offset + 124));//emblem; //演習時のエンブレムとか　1東2西4南8北A(24)ヒーロー状態
                            //this.PutInt(0, (ushort)(offset + 115));//metamo; //メタモーバトルのチーム　1花2岩
                            break;
                            #endregion
                    }
                ...
                if (Configuration.Instance.Version >= SagaLib.Version.Saga17)
                {
                        ...
                        if (value.TranceID == 0 && value.IllusionPictID == 0)
                            for (int j = 0; j < 14; j++)
                            {
                                if (appequips.ContainsKey((EnumEquipSlot)j) || equips.ContainsKey((EnumEquipSlot)j))
                                {
                                    ...
                                    if (item.PictID == 0 ||
                                        item.BaseData.itemType == ItemType.PARTS_BLOW ||//ECOKEY DEM部件融合不影響外觀
                    ...
                    switch (value.Mode)
                    {
                        case PlayerMode.NORMAL:
                            ...
                            break;
                        case PlayerMode.COLISEUM_MODE:
                            this.PutUInt(0x42, (ushort)(offset + 116));//mode1
                            this.PutUInt(1, (ushort)(offset + 120));//mode2
                            break;
                        case PlayerMode.KNIGHT_WAR:
                            this.PutUInt(0x22, (ushort)(offset + 116));//mode1
                            this.PutUInt(2, (ushort)(offset + 120));//mode2
                            break;
                        case PlayerMode.WRP:
                            this.PutUInt(0x102, (ushort)(offset + 116));//mode1
                            this.PutUInt(4, (ushort)(offset + 120));//mode2
                            break;
                        #region "大逃殺專用"
                        case PlayerMode.BATTLE_SOUTH:
                            this.PutUInt(0x22, (ushort)(offset + 116));//mode1
        ...
        ActorPartner SetPartner
        {
            set
            {
                ...
                if (Configuration.Instance.Version >= SagaLib.Version.Saga17)
                {
                    ...
                    //ECOKEY 寵物大小判斷（此ID為有穿衣的豆子不想改就不須複製）
                    if (value.PictID == 92000019)
                    {
                        this.PutUInt(1000, offset + 118);
                    }
                    else
                    {
                        this.PutUInt((uint)(value.BaseData.partnerSize * 1000.0f), offset + 118);
                    }
                    //this.PutUInt(1000, offset + 118);//寵物大小
