...
{
    public class SSMG_PLAYER_MIRROR_ADD_HAIR_COLOR_SLOT_RESULT : Packet
    {
        public SSMG_PLAYER_MIRROR_ADD_HAIR_COLOR_SLOT_RESULT()
        {
        ...
        /// <summary>
        /// GAME_LOOKCHGEXTENDMSG_HAIRCOLOR_ERR0	髪色の保存枠を拡張しました
