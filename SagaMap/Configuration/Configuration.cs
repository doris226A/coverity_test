...
namespace SagaMap
{
    ...
    public class Configuration : Singleton<Configuration>
    {
        ...
        int exprate, questrate, questGoldRate = 100, questUpdateTime = 24, questUpdateAmount = 1, questPointsMax = 15;
        ...
        int _maxcharinmapsrv = 20;

        //Poesession Config
        int possessionrequiretime = 30000;
        int possessionmaxreduce = 20;
        ...
        /// 凭依读条所需时间, 默认30000毫秒
        /// </summary>
        public int PossessionRequireTime { get { return this.possessionrequiretime; } set { this.possessionrequiretime = value; } }

        /// <summary>
        /// 凭依读条最大缩减. wiki已确认20秒 最大で憑依準備時間が10秒まで短縮可能。（最大的凭依准备时间可以缩短到10秒。）http://eco.acronia.net/wiki/?Skill/Druid/Explanation#PossessingSpeedUp
        /// </summary>
        public int PossessionRequireTimeMaxReduce { get { return this.possessionmaxreduce; } set { this.possessionmaxreduce = value; } }
                ...
                foreach (object j in list)
                {
                    ...
                    switch (i.Name.ToLower())
                    {
                        ...
                        case "questspecialrewardrate":
                            ...
                            break;
                        case "possessionrequiretime":
                            this.PossessionRequireTime = int.Parse(i.InnerText);
                            break;
                        case "possessionrequiretimemaxreduce":
                            this.PossessionRequireTimeMaxReduce = int.Parse(i.InnerText);
                            break;
                    }
                }
                if (!getVersion)
