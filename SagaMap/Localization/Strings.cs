...
namespace SagaMap.Localization
{
    public abstract class Strings
    {
        ...
        public string GOLEM_SHOP_BUY_ITEM;
        public string GOLEM_SHOP_BUY_TOTAL_COST;
        public string GOLEM_SHOP_BUY_SETTLEMENT;
        public string GOLEM_SHOP_BUY_ITEM_MESSAGE;

        public string GOLEM_SHOP_SELL_ITEM;
        public string GOLEM_SHOP_SELL_TOTAL_COST;
        public string GOLEM_SHOP_SELL_SETTLEMENT;
