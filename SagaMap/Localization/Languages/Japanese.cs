...
namespace SagaMap.Localization.Languages
{
    public class Japanese : Strings
    {
        public Japanese()
        {
            ...
            this.GOLEM_SHOP_BUY_ITEM = "{1}を{0}個買い取りました。";
            this.GOLEM_SHOP_BUY_TOTAL_COST = "今回の買取金額は{0}Gでした";
            this.GOLEM_SHOP_BUY_SETTLEMENT = "以上石像信息為角色《{0}》的结算。";
            ...
            this.GOLEM_SHOP_SELL_SETTLEMENT = "以上石像信息為角色《{0}》的结算。";
        }
