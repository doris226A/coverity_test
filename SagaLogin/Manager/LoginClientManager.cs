    ...
    public sealed class LoginClientManager : ClientManager
    {
        ...
        LoginClientManager()
        {
            ...
            */
            ...
            this.commandTable.Add(0x012C, new Packets.Client.CSMG_CHAT_CREATE_CHAT_ROOM_REQUEST());
            this.commandTable.Add(0x0131, new Packets.Client.CSMG_CHAT_ENTER_CHAT_ROOM_REQUEST());
            this.commandTable.Add(0x0136, new Packets.Client.CSMG_CHAT_LEAVE_CHAT_ROOM_REQUEST());
            this.commandTable.Add(0x013B, new Packets.Client.CSMG_CHAT_REQUEST_CHAT_ROOM_LIST());
            ...
            this.commandTable.Add(0xDDDF, new Packets.Client.TOOL_GIFTS());
            ...
            //ECOKEY 好友狀態和限時動態
            this.commandTable.Add(0x00EB, new Packets.Client.CSMG_FRIEND_CharStatus_UPDATE());
            this.commandTable.Add(0x00F0, new Packets.Client.CSMG_FRIEND_MEMO_UPDATE());
        ...
        public LoginClient FindClient(SagaDB.Actor.ActorPC pc)
        {
            ...
            chr = from c in chr.ToList()
                  where c.selectedChar != null && c.selectedChar.CharID == pc.CharID
                  select c;
